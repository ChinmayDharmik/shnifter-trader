# Generated: 2025-07-04T09:50:40.004714
...
class ROUTER_equity_calendar(Container):
    ...
    def dividend(
        ...
        **kwargs
        ...
        >>> shnifter.equity.calendar.dividend(provider='fmp')
        """  # noqa: E501
    ...
    def earnings(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.calendar.earnings(provider='fmp')
        >>> # Get earnings calendar for specific dates.
        >>> shnifter.equity.calendar.earnings(start_date='2024-02-01', end_date='2024-02-07', provider='fmp')
        """  # noqa: E501
    ...
    def events(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.calendar.events(provider='fmp')
        >>> # Get company events calendar for specific dates.
        >>> shnifter.equity.calendar.events(start_date='2024-02-01', end_date='2024-02-07', provider='fmp')
        """  # noqa: E501
    ...
    def ipo(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.calendar.ipo(provider='intrinio')
    ...
    def splits(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.calendar.splits(provider='fmp')
        >>> # Get stock splits calendar for specific dates.
        >>> shnifter.equity.calendar.splits(start_date='2024-02-01', end_date='2024-02-07', provider='fmp')
        """  # noqa: E501
