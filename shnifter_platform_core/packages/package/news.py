# Generated: 2025-07-04T09:50:40.034844
...
class ROUTER_news(Container):
    ...
    def company(
        ...
        **kwargs
        ...
        >>> shnifter.news.company(provider='benzinga')
        >>> shnifter.news.company(limit=100, provider='benzinga')
        >>> # Get news on the specified dates.
        >>> shnifter.news.company(symbol='AAPL', start_date='2024-02-01', end_date='2024-02-07', provider='intrinio')
        >>> # Display the headlines of the news.
        >>> shnifter.news.company(symbol='AAPL', display='headline', provider='benzinga')
        >>> # Get news for multiple symbols.
        >>> shnifter.news.company(symbol='aapl,tsla', provider='fmp')
        >>> # Get news company's ISIN.
        >>> shnifter.news.company(symbol='NVDA', isin='US0378331005', provider='benzinga')
        """  # noqa: E501
    ...
    def world(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.news.world(provider='fmp')
        >>> shnifter.news.world(limit=100, provider='intrinio')
        >>> # Get news on the specified dates.
        >>> shnifter.news.world(start_date='2024-02-01', end_date='2024-02-07', provider='intrinio')
        >>> # Display the headlines of the news.
        >>> shnifter.news.world(display='headline', provider='benzinga')
        >>> # Get news by topics.
        >>> shnifter.news.world(topics='finance', provider='benzinga')
        >>> # Get news by source using 'tingo' as provider.
        >>> shnifter.news.world(provider='tiingo', source='bloomberg')
        """  # noqa: E501
