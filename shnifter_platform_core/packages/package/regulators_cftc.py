# Generated: 2025-07-04T09:50:40.036640
...
class ROUTER_regulators_cftc(Container):
    ...
    def cot(
        ...
        **kwargs
        ...
        >>> shnifter.regulators.cftc.cot(id='gold', provider='cftc')
        >>> # Enter the entire history for a single CFTC Market Contract Code.
        >>> shnifter.regulators.cftc.cot(id='088691', provider='cftc')
        >>> # Get the report for futures only.
        >>> shnifter.regulators.cftc.cot(id='088691', futures_only=True, provider='cftc')
        >>> # Get the most recent Commodity Index Traders Supplemental Report.
        >>> shnifter.regulators.cftc.cot(id='all', report_type='supplemental', provider='cftc')
        """  # noqa: E501
    ...
    def cot_search(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.regulators.cftc.cot_search(provider='cftc')
        >>> shnifter.regulators.cftc.cot_search(query='gold', provider='cftc')
        """  # noqa: E501
