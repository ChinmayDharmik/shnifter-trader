# Generated: 2025-07-04T09:50:40.011145
...
class ROUTER_equity_estimates(Container):
    ...
    def analyst_search(
        ...
        **kwargs
        ...
        >>> shnifter.equity.estimates.analyst_search(provider='benzinga')
        >>> shnifter.equity.estimates.analyst_search(firm_name='Wedbush', provider='benzinga')
        """  # noqa: E501
    ...
    def consensus(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.estimates.consensus(symbol='AAPL', provider='fmp')
        >>> shnifter.equity.estimates.consensus(symbol='AAPL,MSFT', provider='yfinance')
        """  # noqa: E501
    ...
    def forward_ebitda(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.estimates.forward_ebitda(provider='intrinio')
        >>> shnifter.equity.estimates.forward_ebitda(symbol='AAPL', fiscal_period='annual', provider='intrinio')
        >>> shnifter.equity.estimates.forward_ebitda(symbol='AAPL,MSFT', fiscal_period='quarter', provider='fmp')
        """  # noqa: E501
    ...
    def forward_eps(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.estimates.forward_eps(symbol='AAPL', provider='intrinio')
        >>> shnifter.equity.estimates.forward_eps(fiscal_year=2025, fiscal_period='fy', provider='intrinio')
        """  # noqa: E501
    ...
    def forward_pe(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.estimates.forward_pe(provider='intrinio')
        >>> shnifter.equity.estimates.forward_pe(symbol='AAPL,MSFT,GOOG', provider='intrinio')
        """  # noqa: E501
    ...
    def forward_sales(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.estimates.forward_sales(symbol='AAPL', provider='intrinio')
        >>> shnifter.equity.estimates.forward_sales(fiscal_year=2025, fiscal_period='fy', provider='intrinio')
        """  # noqa: E501
    ...
    def historical(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.estimates.historical(symbol='AAPL', provider='fmp')
        """  # noqa: E501
    ...
    def price_target(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.estimates.price_target(provider='benzinga')
        >>> # Get price targets for Microsoft using 'benzinga' as provider.
        >>> shnifter.equity.estimates.price_target(start_date='2020-01-01', end_date='2024-02-16', limit=10, symbol='msft', provider='benzinga', action='downgrades')
        """  # noqa: E501
