# Generated: 2025-07-04T09:50:40.033566
...
class ROUTER_index_price(Container):
    ...
    def historical(
        ...
        **kwargs
        ...
        >>> shnifter.index.price.historical(symbol='^GSPC', provider='fmp')
        >>> # Not all providers have the same symbols.
        >>> shnifter.index.price.historical(symbol='SPX', provider='intrinio')
        """  # noqa: E501
