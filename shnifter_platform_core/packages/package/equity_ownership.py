# Generated: 2025-07-04T09:50:40.019197
...
class ROUTER_equity_ownership(Container):
    ...
    def form_13f(
        ...
        **kwargs
        ...
        >>> shnifter.equity.ownership.form_13f(symbol='NVDA', provider='sec')
        >>> # Enter a date (calendar quarter ending) for a specific report.
        >>> shnifter.equity.ownership.form_13f(symbol='BRK-A', date='2016-09-30', provider='sec')
        >>> # Example finding Michael Burry's filings.
        >>> cik = shnifter.regulators.sec.institutions_search("Scion Asset Management").results[0].cik
        >>> # Use the `limit` parameter to return N number of reports from the most recent.
        >>> shnifter.equity.ownership.form_13f(cik, limit=2).to_df()
        """  # noqa: E501
    ...
    def government_trades(
        ...
        chamber: Annotated[
            ...
            ShnifterField(description="Government Chamber."),
        ] = "all",
        limit: Annotated[
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.ownership.government_trades(symbol='AAPL', chamber='all', provider='fmp')
        >>> shnifter.equity.ownership.government_trades(limit=500, chamber='all', provider='fmp')
        """  # noqa: E501
    ...
    def insider_trading(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.ownership.insider_trading(symbol='AAPL', provider='fmp')
        >>> shnifter.equity.ownership.insider_trading(symbol='AAPL', limit=500, provider='intrinio')
        """  # noqa: E501
    ...
    def institutional(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.ownership.institutional(symbol='AAPL', provider='fmp')
        """  # noqa: E501
    ...
    def major_holders(
        ...
        page: Annotated[
            Optional[int], ShnifterField(description="Page number of the data to fetch.")
        ] = 0,
        provider: Annotated[
            Optional[Literal["fmp"]],
            ShnifterField(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.ownership.major_holders(symbol='AAPL', provider='fmp')
        >>> shnifter.equity.ownership.major_holders(symbol='AAPL', page=0, provider='fmp')
        """  # noqa: E501
    ...
    def share_statistics(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.ownership.share_statistics(symbol='AAPL', provider='fmp')
        """  # noqa: E501
