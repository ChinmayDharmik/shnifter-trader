# Generated: 2025-07-04T09:50:40.008866
...
class ROUTER_equity_discovery(Container):
    ...
    def active(
        ...
        **kwargs
        ...
        >>> shnifter.equity.discovery.active(provider='yfinance')
        >>> shnifter.equity.discovery.active(sort='desc', provider='yfinance')
        """  # noqa: E501
    ...
    def aggressive_small_caps(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.discovery.aggressive_small_caps(provider='yfinance')
        >>> shnifter.equity.discovery.aggressive_small_caps(sort='desc', provider='yfinance')
        """  # noqa: E501
    ...
    def filings(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.discovery.filings(provider='fmp')
        >>> # Get filings for the year 2023, limited to 100 results
        >>> shnifter.equity.discovery.filings(start_date='2023-01-01', end_date='2023-12-31', limit=100, provider='fmp')
        """  # noqa: E501
    ...
    def gainers(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.discovery.gainers(provider='yfinance')
        >>> shnifter.equity.discovery.gainers(sort='desc', provider='yfinance')
        """  # noqa: E501
    ...
    def growth_tech(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.discovery.growth_tech(provider='yfinance')
        >>> shnifter.equity.discovery.growth_tech(sort='desc', provider='yfinance')
        """  # noqa: E501
    ...
    def latest_financial_reports(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.discovery.latest_financial_reports(provider='sec')
        >>> shnifter.equity.discovery.latest_financial_reports(provider='sec', date='2024-09-30')
        """  # noqa: E501
    ...
    def losers(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.discovery.losers(provider='yfinance')
        >>> shnifter.equity.discovery.losers(sort='desc', provider='yfinance')
        """  # noqa: E501
    ...
    def undervalued_growth(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.discovery.undervalued_growth(provider='yfinance')
        >>> shnifter.equity.discovery.undervalued_growth(sort='desc', provider='yfinance')
        """  # noqa: E501
    ...
    def undervalued_large_caps(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.discovery.undervalued_large_caps(provider='yfinance')
        >>> shnifter.equity.discovery.undervalued_large_caps(sort='desc', provider='yfinance')
        """  # noqa: E501
