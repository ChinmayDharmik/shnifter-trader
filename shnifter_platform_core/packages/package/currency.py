# Generated: 2025-07-04T09:50:39.963681
...
class ROUTER_currency(Container):
    ...
    def search(
        ...
        query: Annotated[
            Optional[str],
            ShnifterField(description="Query to search for currency pairs."),
        ] = None,
        provider: Annotated[
        ...
        **kwargs
        ...
        >>> shnifter.currency.search(provider='fmp')
        >>> # Search for 'EUR' currency pair using 'intrinio' as provider.
        >>> shnifter.currency.search(provider='intrinio', query='EUR')
        >>> # Search for terms  using 'polygon' as provider.
        >>> shnifter.currency.search(provider='polygon', query='EUR')
        """  # noqa: E501
    ...
    def snapshots(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.currency.snapshots(provider='fmp')
        >>> # Get exchange rates from USD and XAU to EUR, JPY, and GBP using 'fmp' as provider.
        >>> shnifter.currency.snapshots(provider='fmp', base='USD,XAU', counter_currencies='EUR,JPY,GBP', quote_type='indirect')
        """  # noqa: E501
