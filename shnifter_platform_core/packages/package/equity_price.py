# Generated: 2025-07-04T09:50:40.020709
...
class ROUTER_equity_price(Container):
    ...
    def historical(
        ...
        **kwargs
        ...
        >>> shnifter.equity.price.historical(symbol='AAPL', provider='fmp')
        >>> shnifter.equity.price.historical(symbol='AAPL', interval='1d', provider='intrinio')
        """  # noqa: E501
    ...
    def nbbo(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.price.nbbo(symbol='AAPL', provider='polygon')
        """  # noqa: E501
    ...
    def performance(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.price.performance(symbol='AAPL', provider='fmp')
        """  # noqa: E501
    ...
    def quote(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.price.quote(symbol='AAPL', provider='fmp')
        """  # noqa: E501
