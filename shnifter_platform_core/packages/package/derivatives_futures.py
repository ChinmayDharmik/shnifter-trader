# Generated: 2025-07-04T09:50:39.966334
...
class ROUTER_derivatives_futures(Container):
    ...
    def curve(
        ...
        **kwargs
        ...
        >>> shnifter.derivatives.futures.curve(symbol='NG', provider='yfinance')
        """  # noqa: E501
    ...
    def historical(
        ...
        expiration: Annotated[
            Optional[str],
            ShnifterField(description="Future expiry date with format YYYY-MM"),
        ] = None,
        provider: Annotated[
            Optional[Literal["yfinance"]],
            ShnifterField(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.derivatives.futures.historical(symbol='ES', provider='yfinance')
        >>> # Enter multiple symbols.
        >>> shnifter.derivatives.futures.historical(symbol='ES,NQ', provider='yfinance')
        >>> # Enter expiration dates as "YYYY-MM".
        >>> shnifter.derivatives.futures.historical(symbol='ES', provider='yfinance', expiration='2025-12')
        """  # noqa: E501
