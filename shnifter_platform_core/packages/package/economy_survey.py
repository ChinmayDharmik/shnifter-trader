# Generated: 2025-07-04T09:50:40.000993
...
class ROUTER_economy_survey(Container):
    ...
    def bls_search(
        ...
        **kwargs
        ...
        tu - Time Use
            ...
            >>> shnifter.economy.survey.bls_search(provider='bls', category='cpi')
            >>> # Use semi-colon to separate multiple queries as an & operator.
            >>> shnifter.economy.survey.bls_search(provider='bls', category='cpi', query='seattle;gasoline')
        """  # noqa: E501
    ...
    def bls_series(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.economy.survey.bls_series(provider='bls', symbol='CES0000000001')
        """  # noqa: E501
    ...
    def economic_conditions_chicago(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.economy.survey.economic_conditions_chicago(provider='fred')
        """  # noqa: E501
    ...
    def manufacturing_outlook_ny(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.economy.survey.manufacturing_outlook_ny(provider='fred')
        >>> shnifter.economy.survey.manufacturing_outlook_ny(topic='hours_worked,new_orders', transform='pc1', provider='fred', seasonally_adjusted=True)
        """  # noqa: E501
    ...
    def manufacturing_outlook_texas(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.economy.survey.manufacturing_outlook_texas(provider='fred')
        >>> shnifter.economy.survey.manufacturing_outlook_texas(topic='business_outlook,new_orders', transform='pc1', provider='fred')
        """  # noqa: E501
    ...
    def nonfarm_payrolls(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.economy.survey.nonfarm_payrolls(provider='fred')
        >>> shnifter.economy.survey.nonfarm_payrolls(category='avg_hours', provider='fred')
        """  # noqa: E501
    ...
    def sloos(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.economy.survey.sloos(provider='fred')
        >>> shnifter.economy.survey.sloos(category='credit_card', provider='fred')
        """  # noqa: E501
    ...
    def university_of_michigan(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.economy.survey.university_of_michigan(provider='fred')
        """  # noqa: E501
