# Generated: 2025-07-04T09:50:40.024319
...
class ROUTER_etf(Container):
    ...
    def countries(
        ...
        **kwargs
        ...
        >>> shnifter.etf.countries(symbol='VT', provider='fmp')
        """  # noqa: E501
    ...
    def equity_exposure(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.etf.equity_exposure(symbol='MSFT', provider='fmp')
        >>> # This function accepts multiple tickers.
        >>> shnifter.etf.equity_exposure(symbol='MSFT,AAPL', provider='fmp')
        """  # noqa: E501
    ...
    def historical(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.etf.historical(symbol='SPY', provider='fmp')
        >>> shnifter.etf.historical(symbol='SPY', provider='yfinance')
        >>> # This function accepts multiple tickers.
        >>> shnifter.etf.historical(symbol='SPY,IWM,QQQ,DJIA', provider='yfinance')
        """  # noqa: E501
    ...
    def holdings(
        self,
        symbol: Annotated[
            str, ShnifterField(description="Symbol to get data for. (ETF)")
        ],
        provider: Annotated[
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.etf.holdings(symbol='XLK', provider='fmp')
        >>> # Including a date (FMP, SEC) will return the holdings as per NPORT-P filings.
        >>> shnifter.etf.holdings(symbol='XLK', date='2022-03-31', provider='fmp')
        >>> # The same data can be returned from the SEC directly.
        >>> shnifter.etf.holdings(symbol='XLK', date='2022-03-31', provider='sec')
        """  # noqa: E501
    ...
    def holdings_date(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.etf.holdings_date(symbol='XLK', provider='fmp')
        """  # noqa: E501
    ...
    def info(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.etf.info(symbol='SPY', provider='fmp')
        >>> # This function accepts multiple tickers.
        >>> shnifter.etf.info(symbol='SPY,IWM,QQQ,DJIA', provider='fmp')
        """  # noqa: E501
    ...
    def price_performance(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.etf.price_performance(symbol='QQQ', provider='fmp')
        >>> shnifter.etf.price_performance(symbol='SPY,QQQ,IWM,DJIA', provider='fmp')
        """  # noqa: E501
    ...
    def search(
        self,
        query: Annotated[Optional[str], ShnifterField(description="Search query.")] = "",
        provider: Annotated[
            Optional[Literal["fmp", "intrinio"]],
            ShnifterField(
                description="The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: fmp, intrinio."
        ...
        **kwargs
        ...
        >>> from shnifter import shnifter
        >>> # An empty query returns the full list of ETFs from the provider.
        >>> shnifter.etf.search(provider='fmp')
        >>> # The query will return results from text-based fields containing the term.
        >>> shnifter.etf.search(query='commercial real estate', provider='fmp')
        """  # noqa: E501
    ...
    def sectors(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.etf.sectors(symbol='SPY', provider='fmp')
        """  # noqa: E501
