# Generated: 2025-07-04T09:50:39.959703
...
class ROUTER_commodity(Container):
    ...
    def petroleum_status_report(
        ...
        **kwargs
        ...
        >>> shnifter.commodity.petroleum_status_report(provider='eia')
        >>> # Select the category of data, and filter for a specific table within the report.
        >>> shnifter.commodity.petroleum_status_report(category='weekly_estimates', table='imports', provider='eia')
        """  # noqa: E501
    ...
    def short_term_energy_outlook(
        ...
        **kwargs
        ...
        >>> shnifter.commodity.short_term_energy_outlook(provider='eia')
        >>> # Select the specific table of data from the STEO. Table 03d is World Crude Oil Production.
        >>> shnifter.commodity.short_term_energy_outlook(table='03d', provider='eia')
        """  # noqa: E501
