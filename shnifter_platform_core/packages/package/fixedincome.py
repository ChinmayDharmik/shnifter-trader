# Generated: 2025-07-04T09:50:40.025966
...
class ROUTER_fixedincome(Container):
    ...
    def bond_indices(
        ...
        **kwargs
        ...
        >>> shnifter.fixedincome.bond_indices(provider='fred')
        >>> # Multiple indices, from within the same 'category', can be requested.
        >>> shnifter.fixedincome.bond_indices(category='high_yield', index='us,europe,emerging', index_type='total_return', provider='fred')
        >>> # From FRED, there are three main categories, 'high_yield', 'us', and 'emerging_markets'. Emerging markets is a broad category.
        >>> shnifter.fixedincome.bond_indices(category='emerging_markets', index='corporate,private_sector,public_sector', provider='fred')
        """  # noqa: E501
    ...
    def mortgage_indices(
        ...
        **kwargs
        ...
        >>> shnifter.fixedincome.mortgage_indices(provider='fred')
        >>> # Multiple indices can be requested.
        >>> shnifter.fixedincome.mortgage_indices(index='jumbo_30y,conforming_30y,conforming_15y', provider='fred')
        """  # noqa: E501
    ...
    @validate
    @deprecated(
        "This endpoint is deprecated; use `/fixedincome/rate/sofr` instead. Deprecated in Shnifter Engine V4.2 to be removed in V4.5.",
    ...
    def sofr(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.sofr(provider='fred')
        """  # noqa: E501
