# Generated: 2025-07-04T09:50:40.037904
...
class ROUTER_regulators_sec(Container):
    ...
    def cik_map(
        ...
        **kwargs
        ...
        >>> shnifter.regulators.sec.cik_map(symbol='MSFT', provider='sec')
        """  # noqa: E501
    ...
    def filing_headers(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.regulators.sec.filing_headers(url='https://www.sec.gov/Archives/edgar/data/317540/000119312524076556/d645509ddef14a.htm', provider='sec')
        """  # noqa: E501
    ...
    def htm_file(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.regulators.sec.htm_file(url='https://www.sec.gov/Archives/edgar/data/1723690/000119312525030074/d866336dex991.htm', provider='sec')
        """  # noqa: E501
    ...
    def institutions_search(
        self,
        query: Annotated[str, ShnifterField(description="Search query.")] = "",
        provider: Annotated[
            Optional[Literal["sec"]],
            ShnifterField(
                description="The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: sec."
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.regulators.sec.institutions_search(provider='sec')
        >>> shnifter.regulators.sec.institutions_search(query='blackstone real estate', provider='sec')
        """  # noqa: E501
    ...
    def rss_litigation(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.regulators.sec.rss_litigation(provider='sec')
        """  # noqa: E501
    ...
    def schema_files(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.regulators.sec.schema_files(provider='sec')
    ...
    def sic_search(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.regulators.sec.sic_search(provider='sec')
        >>> shnifter.regulators.sec.sic_search(query='real estate investment trusts', provider='sec')
        """  # noqa: E501
    ...
    def symbol_map(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.regulators.sec.symbol_map(query='0000789019', provider='sec')
        """  # noqa: E501
