# Generated: 2025-07-04T09:50:40.006847
...
class ROUTER_equity_compare(Container):
    ...
    def company_facts(
        ...
        **kwargs
        ...
        >>> shnifter.equity.compare.company_facts(provider='sec')
        >>> shnifter.equity.compare.company_facts(provider='sec', fact='PaymentsForRepurchaseOfCommonStock', year=2023)
        >>> shnifter.equity.compare.company_facts(provider='sec', symbol='NVDA,AAPL,AMZN,MSFT,GOOG,SMCI', fact='RevenueFromContractWithCustomerExcludingAssessedTax', year=2024)
        """  # noqa: E501
    ...
    def peers(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.equity.compare.peers(symbol='AAPL', provider='fmp')
        """  # noqa: E501
