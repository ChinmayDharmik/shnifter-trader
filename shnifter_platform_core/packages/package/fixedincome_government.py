# Generated: 2025-07-04T09:50:40.028572
...
class ROUTER_fixedincome_government(Container):
    ...
    def tips_yields(
        ...
        **kwargs
        ...
        >>> shnifter.fixedincome.government.tips_yields(provider='fred')
        >>> shnifter.fixedincome.government.tips_yields(maturity='10', provider='fred')
        """  # noqa: E501
    ...
    def treasury_rates(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.government.treasury_rates(provider='fmp')
        """  # noqa: E501
    ...
    def yield_curve(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.government.yield_curve(provider='federal_reserve')
        >>> shnifter.fixedincome.government.yield_curve(date='2023-05-01,2024-05-01', provider='fmp')
        >>> shnifter.fixedincome.government.yield_curve(date='2023-05-01', country='united_kingdom', provider='econdb')
        >>> shnifter.fixedincome.government.yield_curve(provider='fred', yield_curve_type='real', date='2023-05-01,2024-05-01')
        """  # noqa: E501
