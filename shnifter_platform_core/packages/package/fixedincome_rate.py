# Generated: 2025-07-04T09:50:40.030506
...
class ROUTER_fixedincome_rate(Container):
    ...
    def ameribor(
        ...
        **kwargs
        ...
        >>> shnifter.fixedincome.rate.ameribor(provider='fred')
        >>> # The change from one year ago is applied with the transform parameter.
        >>> shnifter.fixedincome.rate.ameribor(maturity='all', transform='pc1', provider='fred')
        """  # noqa: E501
    ...
    def dpcredit(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.rate.dpcredit(provider='fred')
        >>> shnifter.fixedincome.rate.dpcredit(start_date='2023-02-01', end_date='2023-05-01', provider='fred')
        """  # noqa: E501
    ...
    def ecb(
        ...
        interest_rate_type: Annotated[
            ...
            ShnifterField(description="The type of interest rate."),
        ] = "lending",
        provider: Annotated[
            Optional[Literal["fred"]],
            ShnifterField(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.rate.ecb(provider='fred')
        >>> shnifter.fixedincome.rate.ecb(interest_rate_type='refinancing', provider='fred')
        """  # noqa: E501
    ...
    def effr(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.rate.effr(provider='fred')
        >>> shnifter.fixedincome.rate.effr(effr_only=True, provider='fred')
        """  # noqa: E501
    ...
    def effr_forecast(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.rate.effr_forecast(provider='fred')
        >>> shnifter.fixedincome.rate.effr_forecast(long_run=True, provider='fred')
        """  # noqa: E501
    ...
    def estr(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.rate.estr(provider='fred')
        >>> shnifter.fixedincome.rate.estr(transform='ch1', provider='fred')
        """  # noqa: E501
    ...
    def iorb(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.rate.iorb(provider='fred')
        """  # noqa: E501
    ...
    def overnight_bank_funding(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.rate.overnight_bank_funding(provider='fred')
        """  # noqa: E501
    ...
    def sofr(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.rate.sofr(provider='fred')
        """  # noqa: E501
    ...
    def sonia(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.rate.sonia(provider='fred')
        >>> shnifter.fixedincome.rate.sonia(parameter='total_nominal_value', provider='fred')
        """  # noqa: E501
