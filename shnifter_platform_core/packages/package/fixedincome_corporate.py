# Generated: 2025-07-04T09:50:40.027415
...
class ROUTER_fixedincome_corporate(Container):
    ...
    def commercial_paper(
        ...
        **kwargs
        ...
        >>> shnifter.fixedincome.corporate.commercial_paper(provider='fred')
        >>> shnifter.fixedincome.corporate.commercial_paper(category='all', maturity='15d', provider='fred')
        """  # noqa: E501
    ...
    def hqm(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.corporate.hqm(provider='fred')
        >>> shnifter.fixedincome.corporate.hqm(yield_curve='par', provider='fred')
        """  # noqa: E501
    ...
    @validate
    @deprecated(
        "This endpoint is deprecated; use `/fixedincome/bond_indices` instead. Deprecated in Shnifter Engine V4.2 to be removed in V4.5.",
    ...
    def ice_bofa(
        ...
        index_type: Annotated[
            ...
            ShnifterField(description="The type of series."),
        ] = "yield",
        provider: Annotated[
            Optional[Literal["fred"]],
            ShnifterField(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.corporate.ice_bofa(provider='fred')
        >>> shnifter.fixedincome.corporate.ice_bofa(index_type='yield_to_worst', provider='fred')
        """  # noqa: E501
    ...
    @validate
    @deprecated(
        "This endpoint is deprecated; use `/fixedincome/bond_indices` instead. Set `category` to `us` and `index` to `seasoned_corporate`. Deprecated in Shnifter Engine V4.2 to be removed in V4.5.",
        category=ShnifterDeprecationWarning,
    )
    def moody(
        self,
        ...
        index_type: Annotated[
            Literal["aaa", "baa"], ShnifterField(description="The type of series.")
        ] = "aaa",
        provider: Annotated[
            Optional[Literal["fred"]],
            ShnifterField(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.corporate.moody(provider='fred')
        >>> shnifter.fixedincome.corporate.moody(index_type='baa', provider='fred')
        """  # noqa: E501
    ...
    def spot_rates(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.fixedincome.corporate.spot_rates(provider='fred')
        >>> shnifter.fixedincome.corporate.spot_rates(maturity='10,20,30,50', provider='fred')
        """  # noqa: E501
