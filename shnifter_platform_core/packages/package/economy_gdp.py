# Generated: 2025-07-04T09:50:39.987761
...
class ROUTER_economy_gdp(Container):
    ...
    def forecast(
        ...
        **kwargs
        ...
        'current_prices', 'volume', and 'capita' are expressed in USD;
                ...
                >>> shnifter.economy.gdp.forecast(provider='oecd')
                >>> shnifter.economy.gdp.forecast(country='united_states,germany,france', frequency='annual', units='capita', provider='oecd')
        """  # noqa: E501
    ...
    def nominal(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.economy.gdp.nominal(provider='oecd')
        >>> shnifter.economy.gdp.nominal(units='capita', country='all', frequency='annual', provider='oecd')
        """  # noqa: E501
    ...
    def real(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.economy.gdp.real(provider='oecd')
        >>> shnifter.economy.gdp.real(country='united_states,germany,japan', provider='econdb')
        """  # noqa: E501
