# Generated: 2025-07-04T09:50:39.998187
...
class ROUTER_economy_shipping(Container):
    ...
    def chokepoint_info(
        ...
        **kwargs
        ...
        theme : Optional[Literal['dark', 'light']]
            Theme for the map. Only valid if `shnifter-charting` is installed and `chart` parameter is set to `true`. Default is the 'chart_style' setting in `user_settings.json`, if available, otherwise 'dark'. (provider: imf)
        ...
        >>> shnifter.economy.shipping.chokepoint_info(provider='imf')
        """  # noqa: E501
    ...
    def chokepoint_volume(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.economy.shipping.chokepoint_volume(provider='imf')
        >>> shnifter.economy.shipping.chokepoint_volume(provider='imf', chokepoint='suez_canal,panama_canal')
        """  # noqa: E501
    ...
    def port_info(
        ...
        **kwargs
        ...
        --------
        >>> from shnifter import shnifter
        >>> shnifter.economy.shipping.port_info(provider='imf')
        >>> shnifter.economy.shipping.port_info(provider='imf', continent='asia_pacific')
        """  # noqa: E501
    ...
    def port_volume(
        ...
        **kwargs
        ...
        >>> shnifter.economy.shipping.port_volume(provider='econdb')
        ...
        >>> shnifter.economy.shipping.port_volume(provider='imf', port_code='rotterdam,singapore')
        >>> # Get data for all ports in a specific country. Use the 3-letter ISO country code.
        >>> shnifter.economy.shipping.port_volume(provider='imf', country='GBR')
        """  # noqa: E501
