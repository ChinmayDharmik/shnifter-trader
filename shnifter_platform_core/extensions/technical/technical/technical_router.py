# Generated: 2025-07-04T09:50:40.085766
...
from shnifter_core.app.utils import (
    basemodel_to_df,
    df_to_basemodel,
    get_target_column,
    get_target_columns,
...
from shnifter_technical.helpers import (
    calculate_cones,
    calculate_fib_levels,
    clenow_momentum,
    validate_data,
)
from shnifter_technical.relative_rotation import (
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical("
                + "symbol='AAPL,MSFT,GOOGL,META,AMZN,TSLA,SPY', start_date='2022-01-01', provider='yfinance')",
                "rr_data = shnifter.technical.relative_rotation(data=stock_data.results, benchmark='SPY')",
        ...
        PythonEx(
            ...
            code=[
                "crypto_data = shnifter.crypto.price.historical("
                + " symbol='BTCUSD,ETHUSD,SOLUSD', start_date='2021-01-01', provider='yfinance')",
                "rr_data = shnifter.technical.relative_rotation(data=crypto_data.results, benchmark='BTC-USD',"
...
async def relative_rotation(
...
) -> Shnifterject[RelativeRotationData]:
    ...
    chart_params : dict[str, Any], optional
        Additional parameters to pass when `chart=True` and the `shnifter-charting` extension is installed.
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "atr_data = shnifter.technical.atr(data=stock_data.results)",
            ],
        ),
...
def atr(
    ...
    return Shnifterject(results=results)
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "fib_data = shnifter.technical.fib(data=stock_data.results, period=120)",
            ],
        ),
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "obv_data = shnifter.technical.obv(data=stock_data.results, offset=0)",
            ],
        ),
        APIEx(parameters={"data": APIEx.mock_data("timeseries")}),
    ],
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "fisher_data = shnifter.technical.fisher(data=stock_data.results, length=14, signal=1)",
            ],
        ),
        APIEx(parameters={"length": 2, "data": APIEx.mock_data("timeseries")}),
    ],
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "adosc_data = shnifter.technical.adosc(data=stock_data.results, fast=3, slow=10, offset=0)",
            ],
        ),
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "bbands_data = shnifter.technical.bbands(data=stock_data.results, target='close', length=50, std=2, mamode='sma')",  # noqa: E501
            ],
        ),
        APIEx(parameters={"length": 2, "data": APIEx.mock_data("timeseries")}),
    ],
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "zlma_data = shnifter.technical.zlma(data=stock_data.results, target='close', length=50, offset=0)",
            ],
        ),
        APIEx(parameters={"length": 2, "data": APIEx.mock_data("timeseries")}),
    ],
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "aaron_data = shnifter.technical.aroon(data=stock_data.results, length=25, scalar=100)",
            ],
        ),
        APIEx(parameters={"length": 2, "data": APIEx.mock_data("timeseries")}),
    ],
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "sma_data = shnifter.technical.sma(data=stock_data.results, target='close', length=50, offset=0)",
            ],
        ),
        APIEx(parameters={"length": 2, "data": APIEx.mock_data("timeseries")}),
    ],
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "demark_data = shnifter.technical.demark(data=stock_data.results, offset=0)",
            ],
        ),
        APIEx(parameters={"data": APIEx.mock_data("timeseries")}),
    ],
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "vwap_data = shnifter.technical.vwap(data=stock_data.results, anchor='D', offset=0)",
            ],
        ),
        APIEx(parameters={"data": APIEx.mock_data("timeseries")}),
    ],
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "macd_data = shnifter.technical.macd(data=stock_data.results, target='close', fast=12, slow=26, signal=9)",
            ],
        ),
        APIEx(
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "hma_data = shnifter.technical.hma(data=stock_data.results, target='close', length=50, offset=0)",
            ],
        ),
    ],
)
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "donchian_data = shnifter.technical.donchian(data=stock_data.results, lower_length=20, upper_length=20, offset=0)",  # noqa: E501
            ],
        ),
        APIEx(
            parameters={
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "ichimoku_data = shnifter.technical.ichimoku(data=stock_data.results, conversion=9, base=26, lookahead=False)",
            ],
        ),
    ],
)
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "clenow_data = shnifter.technical.clenow(data=stock_data.results, period=90)",
            ],
        ),
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "ad_data = shnifter.technical.ad(data=stock_data.results, offset=0)",
            ],
        ),
        APIEx(parameters={"data": APIEx.mock_data("timeseries")}),
    ],
)
def ad(data: list[Data], index: str = "date", offset: int = 0) -> Shnifterject[list[Data]]:
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "adx_data = shnifter.technical.adx(data=stock_data.results, length=50, scalar=100.0, drift=1)",
            ],
        ),
        APIEx(parameters={"length": 2, "data": APIEx.mock_data("timeseries")}),
    ],
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "wma_data = shnifter.technical.wma(data=stock_data.results, target='close', length=50, offset=0)",
            ],
        ),
        APIEx(parameters={"length": 2, "data": APIEx.mock_data("timeseries")}),
    ],
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "cci_data = shnifter.technical.cci(data=stock_data.results, length=14, scalar=0.015)",
            ],
        ),
        APIEx(parameters={"length": 2, "data": APIEx.mock_data("timeseries")}),
    ],
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "rsi_data = shnifter.technical.rsi(data=stock_data.results, target='close', length=14, scalar=100.0, drift=1)",
            ],
        ),
        APIEx(parameters={"length": 2, "data": APIEx.mock_data("timeseries")}),
    ],
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "stoch_data = shnifter.technical.stoch(data=stock_data.results, fast_k_period=14, slow_d_period=3, slow_k_period=3)",  # noqa: E501  # pylint: disable=line-too-long
            ],
        ),
    ],
)
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "kc_data = shnifter.technical.kc(data=stock_data.results, length=20, scalar=20, mamode='ema', offset=0)",
            ],
        ),
        APIEx(parameters={"length": 2, "data": APIEx.mock_data("timeseries")}),
    ],
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "cg_data = shnifter.technical.cg(data=stock_data.results, length=14)",
            ],
        ),
        APIEx(parameters={"length": 2, "data": APIEx.mock_data("timeseries")}),
    ],
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='yfinance')",
                "cones_data = shnifter.technical.cones(data=stock_data.results, lower_q=0.25, upper_q=0.75, model='std')",
            ],
        ),
        APIEx(parameters={"data": APIEx.mock_data("timeseries")}),
    ],
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp')",
                "ema_data = shnifter.technical.ema(data=stock_data.results, target='close', length=50, offset=0)",
            ],
        ),
        APIEx(parameters={"length": 2, "data": APIEx.mock_data("timeseries")}),
    ],
