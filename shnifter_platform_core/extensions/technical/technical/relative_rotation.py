# Generated: 2025-07-04T09:50:40.083257
...
class RelativeRotation:
    ...
    def __init__(
        ...
        from shnifter_core.app.model.shnifterject import Shnifterject  # noqa
        ...
        if isinstance(data, Shnifterject):
    ...
    def _process_data(self):
        """Process the data."""
        # pylint: disable=import-outside-toplevel
        from shnifter_core.app.utils import df_to_basemodel
...
class RelativeRotationQueryParams(QueryParams):
    ...
    chart_params: Optional[Dict[str, Any]] = Field(
        default=None,
        description="Additional parameters to pass when `chart=True` and the `shnifter-charting` extension is installed."
    ...
    def convert_data(cls, v):
        ...
        from shnifter_core.app.utils import convert_to_basemodel, df_to_basemodel
        from pandas import DataFrame

        if isinstance(v, Shnifterject):
            return v.results
