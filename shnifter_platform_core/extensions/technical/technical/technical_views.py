# Generated: 2025-07-04T09:50:40.087200
...
from shnifter_charting.core.to_chart import to_chart
from shnifter_charting.styles.colors import LARGE_CYCLER

if TYPE_CHECKING:
    from shnifter_charting.core.shnifter_figure import ShnifterFigure
...
class TechnicalViews:
    ...
    @staticmethod
    def technical_sma(**kwargs) -> tuple["ShnifterFigure", dict[str, Any]]:
    ...
    @staticmethod
    def technical_ema(**kwargs) -> tuple["ShnifterFigure", dict[str, Any]]:
    ...
    @staticmethod
    def technical_hma(**kwargs) -> tuple["ShnifterFigure", dict[str, Any]]:
    ...
    @staticmethod
    def technical_wma(**kwargs) -> tuple["ShnifterFigure", dict[str, Any]]:
    ...
    @staticmethod
    def technical_zlma(**kwargs) -> tuple["ShnifterFigure", dict[str, Any]]:
    ...
    @staticmethod
    def technical_aroon(**kwargs) -> tuple["ShnifterFigure", dict[str, Any]]:
        """Technical Aroon Chart."""
        # pylint: disable=import-outside-toplevel
        from shnifter_charting.core.plotly_ta.ta_class import PlotlyTA
        ...
        if "data" in kwargs and isinstance(kwargs["data"], DataFrame):
            ...
            data = basemodel_to_df(
                kwargs["shnifterject_item"], index=kwargs.get("index", "date")
            )
    ...
    @staticmethod
    def technical_macd(**kwargs) -> tuple["ShnifterFigure", dict[str, Any]]:
    ...
    @staticmethod
    def technical_adx(**kwargs) -> tuple["ShnifterFigure", dict[str, Any]]:
    ...
    @staticmethod
    def technical_rsi(**kwargs) -> tuple["ShnifterFigure", dict[str, Any]]:
    ...
    @staticmethod
    def technical_cones(**kwargs) -> tuple["ShnifterFigure", dict[str, Any]]:
        """Volatility Cones Chart."""
        # pylint: disable=import-outside-toplevel
        from shnifter_charting.core.chart_style import ChartStyle
        from shnifter_charting.core.shnifter_figure import ShnifterFigure
        from shnifter_core.app.utils import basemodel_to_df
        from pandas import DataFrame
        ...
        if isinstance(data, DataFrame) and not data.empty and "window" in data.columns:
            ...
            df_ta = basemodel_to_df(kwargs["shnifterject_item"], index="window")  # type: ignore
    ...
    def technical_relative_rotation(
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
        from shnifter_charting.charts import relative_rotation  # noqa
        from shnifter_charting.core.chart_style import ChartStyle  # noqa
        ...
        ratios_df = basemodel_to_df(kwargs["shnifterject_item"].rs_ratios, index="date")  # type: ignore
        momentum_df = basemodel_to_df(kwargs["shnifterject_item"].rs_momentum, index="date")  # type: ignore
        benchmark_symbol = kwargs["shnifterject_item"].benchmark  # type: ignore
        study = kwargs.get("study")
        study = str(kwargs["shnifterject_item"].study) if study is None else str(study)
        ...
        figure = ShnifterFigure(fig)  # pylint: disable=E0606
...
def _ta_ma(**kwargs):
    ...
    if data is None:
        data = basemodel_to_df(kwargs["shnifterject_item"], index=index)
