# Generated: 2025-07-04T09:50:40.102188
# Target: Shnifter Trader Platform with PySide6 and LLM integration
# Python Version: 3.13.2+

"""Shnifter Performance Extension router."""
    ...
    examples=[
        PythonEx(
            ...
            code=[
                ...
                'shnifter.quantitative.performance.omega_ratio(data=returns, target="close")',
            ],
        ),
        APIEx(
            parameters={
    ...
    examples=[
        PythonEx(
            ...
            code=[
                ...
                'returns = stock_data["close"].pct_change().dropna()',
                'shnifter.quantitative.performance.sharpe_ratio(data=returns, target="close")',
            ],
        ),
        APIEx(
            parameters={
    ...
    examples=[
        PythonEx(
            ...
            code=[
                'stock_data = shnifter.equity.price.historical(symbol="TSLA", start_date="2023-01-01", provider="fmp").to_df()',  # noqa: E501
                'returns = stock_data["close"].pct_change().dropna()',
                'shnifter.quantitative.performance.sortino_ratio(data=stock_data, target="close")',
                'shnifter.quantitative.performance.sortino_ratio(data=stock_data, target="close", target_return=0.01, window=126, adjusted=True)',  # noqa: E501  pylint: disable=line-too-long
            ],
        ),
        APIEx(
            parameters={
...
def sortino_ratio(
    ...
    return Shnifterject(results=results_)
