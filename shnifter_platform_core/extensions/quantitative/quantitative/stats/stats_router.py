# Generated: 2025-07-04T09:50:40.105060
    ...
    examples=[
        PythonEx(
            ...
            code=[
                ...
                'shnifter.quantitative.stats.skew(data=returns, target="close")',
            ],
        ),
        APIEx(
            parameters={
    ...
    examples=[
        PythonEx(
            ...
            code=[
                'stock_data = shnifter.equity.price.historical(symbol="TSLA", start_date="2023-01-01", provider="fmp").to_df()',  # noqa: E501
                'returns = stock_data["close"].pct_change().dropna()',
                'shnifter.quantitative.stats.variance(data=returns, target="close")',
            ],
        ),
        APIEx(
            parameters={
...
def variance(data: list[Data], target: str) -> Shnifterject[list[Data]]:
    ...
    examples=[
        PythonEx(
            ...
            code=[
                'stock_data = shnifter.equity.price.historical(symbol="TSLA", start_date="2023-01-01", provider="fmp").to_df()',  # noqa: E501
                'returns = stock_data["close"].pct_change().dropna()',
                'shnifter.quantitative.stats.stdev(data=returns, target="close")',
            ],
        ),
        APIEx(
            parameters={
...
def stdev(data: list[Data], target: str) -> Shnifterject[list[Data]]:
    ...
    examples=[
        PythonEx(
            ...
            code=[
                'stock_data = shnifter.equity.price.historical(symbol="TSLA", start_date="2023-01-01", provider="fmp").to_df()',  # noqa: E501
                'returns = stock_data["close"].pct_change().dropna()',
                'shnifter.quantitative.stats.kurtosis(data=returns, target="close")',
            ],
        ),
        APIEx(
            parameters={
...
def kurtosis(data: list[Data], target: str) -> Shnifterject[list[Data]]:
    ...
    examples=[
        PythonEx(
            ...
            code=[
                'stock_data = shnifter.equity.price.historical(symbol="TSLA", start_date="2023-01-01", provider="fmp").to_df()',  # noqa: E501
                'returns = stock_data["close"].pct_change().dropna()',
                'shnifter.quantitative.stats.quantile(data=returns, target="close", quantile_pct=0.75)',
            ],
        ),
        APIEx(
            parameters={
    ...
    examples=[
        PythonEx(
            ...
            code=[
                'stock_data = shnifter.equity.price.historical(symbol="TSLA", start_date="2023-01-01", provider="fmp").to_df()',  # noqa: E501
                'returns = stock_data["close"].pct_change().dropna()',
                'shnifter.quantitative.stats.mean(data=returns, target="close")',
            ],
        ),
        APIEx(
            parameters={
