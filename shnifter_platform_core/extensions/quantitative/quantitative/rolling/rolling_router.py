# Generated: 2025-07-04T09:50:40.103752
    ...
    examples=[
        PythonEx(
            ...
            code=[
                ...
                'shnifter.quantitative.rolling.skew(data=returns, target="close")',
            ],
        ),
        APIEx(
            parameters={
...
def skew(
    ...
    from shnifter_quantitative.helpers import validate_window
    from shnifter_quantitative.statistics import skew_
    ...
    examples=[
        PythonEx(
            ...
            code=[
                'stock_data = shnifter.equity.price.historical(symbol="TSLA", start_date="2023-01-01", provider="fmp").to_df()',  # noqa: E501
                'returns = stock_data["close"].pct_change().dropna()',
                'shnifter.quantitative.rolling.variance(data=returns, target="close", window=252)',
            ],
        ),
        APIEx(
            parameters={
...
def variance(
    ...
    from shnifter_quantitative.helpers import validate_window
    from shnifter_quantitative.statistics import var_
    ...
    examples=[
        PythonEx(
            ...
            code=[
                'stock_data = shnifter.equity.price.historical(symbol="TSLA", start_date="2023-01-01", provider="fmp").to_df()',  # noqa: E501
                'returns = stock_data["close"].pct_change().dropna()',
                'shnifter.quantitative.rolling.stdev(data=returns, target="close", window=252)',
            ],
        ),
        APIEx(
            parameters={
...
def stdev(
    ...
    from shnifter_quantitative.helpers import validate_window
    from shnifter_quantitative.statistics import std_dev_
    ...
    examples=[
        PythonEx(
            ...
            code=[
                'stock_data = shnifter.equity.price.historical(symbol="TSLA", start_date="2023-01-01", provider="fmp").to_df()',  # noqa: E501
                'returns = stock_data["close"].pct_change().dropna()',
                'shnifter.quantitative.rolling.kurtosis(data=returns, target="close", window=252)',
            ],
        ),
        APIEx(
            parameters={
...
def kurtosis(
    ...
    from shnifter_quantitative.helpers import validate_window
    from shnifter_quantitative.statistics import kurtosis_
    ...
    examples=[
        PythonEx(
            ...
            code=[
                'stock_data = shnifter.equity.price.historical(symbol="TSLA", start_date="2023-01-01", provider="fmp").to_df()',  # noqa: E501
                'returns = stock_data["close"].pct_change().dropna()',
                'shnifter.quantitative.rolling.quantile(data=returns, target="close", window=252, quantile_pct=0.25)',
                'shnifter.quantitative.rolling.quantile(data=returns, target="close", window=252, quantile_pct=0.75)',
            ],
        ),
        APIEx(
            parameters={
    ...
    examples=[
        PythonEx(
            ...
            code=[
                'stock_data = shnifter.equity.price.historical(symbol="TSLA", start_date="2023-01-01", provider="fmp").to_df()',  # noqa: E501
                'returns = stock_data["close"].pct_change().dropna()',
                'shnifter.quantitative.rolling.mean(data=returns, target="close", window=252)',
            ],
        ),
        APIEx(
            parameters={
...
def mean(
    ...
    from shnifter_quantitative.helpers import validate_window
    from shnifter_quantitative.statistics import mean_
