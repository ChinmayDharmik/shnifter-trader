# Generated: 2025-07-04T09:50:40.176752
...
class EconomyViews:
    ...
    def economy_fred_series(
        **kwargs,
        ...
        columns = basemodel_to_df(kwargs["shnifterject_item"], index=None).columns.to_list()  # type: ignore
        ...
        if isinstance(data, DataFrame) and not data.empty:
            ...
            df_ta = basemodel_to_df(kwargs["shnifterject_item"], index="date")  # type: ignore
        ...
        fig = ShnifterFigure().create_subplots(
    ...
    def economy_survey_bls_series(
        **kwargs,
        ...
        """
        # pylint: disable=import-outside-toplevel
        from shnifter_charting.charts.generic_charts import bar_chart, line_chart
        from shnifter_charting.charts.helpers import (
            z_score_standardization,
        )
        from shnifter_core.app.utils import basemodel_to_df
        ...
        _data = (
            ...
            else kwargs.get("shnifterject_item")
        )
        df = DataFrame()
    ...
    def economy_shipping_chokepoint_info(
        **kwargs,
        ...
        try:
            from shnifter_imf.views.maritime_chokepoint_info import (
    ...
    def economy_shipping_port_info(
        **kwargs,
        ...
        try:
            from shnifter_imf.views.port_info import (
                plot_port_info_map,
            )
        except Exception as e:
            raise RuntimeError("Unable to import the required module.") from e
