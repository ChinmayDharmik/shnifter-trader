# Generated: 2025-07-04T09:50:40.175230
...
from shnifter_economy.gdp.gdp_router import router as gdp_router
from shnifter_economy.shipping.shipping_router import router as shipping_router
from shnifter_economy.survey.survey_router import router as survey_router
...
async def fomc_documents(
    ...
    """
    results = await Shnifterject.from_query(Query(**locals()))
