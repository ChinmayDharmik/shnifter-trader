# Generated: 2025-07-04T09:50:40.184611
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp').to_df()",  # noqa: E501
                "shnifter.econometrics.correlation_matrix(data=stock_data)",
            ],
        ),
...
def correlation_matrix(
    ...
    import numpy as np
    from shnifter_core.app.utils import basemodel_to_df
    ...
    for k, v in corr.items():
        v["comp_to"] = k
        ret.append(Data(**v))
    return Shnifterject(results=ret)
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp').to_df()",  # noqa: E501
                'shnifter.econometrics.ols_regression(data=stock_data, y_column="close", x_columns=["open", "high", "low"])',
            ],
        ),
        APIEx(
            parameters={
...
def ols_regression(
    ...
    -------
    Shnifterject[dict]
        Shnifterject with the results being model and results objects.
    """
    # pylint: disable=import-outside-toplevel
    ...
    model = sm.OLS(y, X)
    results = model.fit()
    return Shnifterject(results={"model": model, "results": results})
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp').to_df()",  # noqa: E501  pylint: disable=line-too-long
                'shnifter.econometrics.ols_regression_summary(data=stock_data, y_column="close", x_columns=["open", "high", "low"])',  # noqa: E501  pylint: disable=line-too-long
            ],
        ),
        APIEx(
            parameters={
...
def ols_regression_summary(
    ...
    -------
    Shnifterject[Data]
        Shnifterject with the results being summary object.
    """
    # pylint: disable=import-outside-toplevel
    import re  # noqa
    ...
    return Shnifterject(results=clean_results)
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp').to_df()",  # noqa: E501
                'shnifter.econometrics.autocorrelation(data=stock_data, y_column="close", x_columns=["open", "high", "low"])',
            ],
        ),
        APIEx(
            parameters={
...
def autocorrelation(
    ...
    -------
    Shnifterject[dict]
        Shnifterject with the results being the score from the test.
    """
    # pylint: disable=import-outside-toplevel
    import statsmodels.api as sm
    from shnifter_core.app.utils import (
    ...
    y = get_target_column(basemodel_to_df(data), y_column)
    results = sm.OLS(y, X).fit()
    return Shnifterject(results=Data(score=durbin_watson(results.resid)))
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp').to_df()",  # noqa: E501
                'shnifter.econometrics.residual_autocorrelation(data=stock_data, y_column="close", x_columns=["open", "high", "low"])',  # noqa: E501  pylint: disable=line-too-long
            ],
        ),
        APIEx(
            parameters={
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp').to_df()",  # noqa: E501
                'shnifter.econometrics.cointegration(data=stock_data, columns=["open", "close"])',
            ],
        ),
    ],
)
def cointegration(
    ...
    """
    # pylint: disable=import-outside-toplevel
    from shnifter_core.app.utils import basemodel_to_df, get_target_columns  # noqa
    from shnifter_econometrics.utils import (  # noqa
    ...
    return Shnifterject(results=result)
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp').to_df()",  # noqa: E501
                'shnifter.econometrics.causality(data=stock_data, y_column="close", x_column="open")',
            ],
        ),
        APIEx(
...
def causality(
    ...
    """
    # pylint: disable=import-outside-toplevel
    from shnifter_core.app.utils import basemodel_to_df, get_target_column
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='fmp').to_df()",  # noqa: E501
                'shnifter.econometrics.unit_root(data=stock_data, column="close")',
                'shnifter.econometrics.unit_root(data=stock_data, column="close", regression="ct")',
            ],
        ),
        APIEx(
            parameters={
...
def panel_random_effects(
    ...
    -------
    Shnifterject[dict]
        Shnifterject with the fit model returned
    """
    # pylint: disable=import-outside-toplevel
    import statsmodels.api as sm
    ...
    return Shnifterject(results={"results": results})
...
@router.command(
    ...
    examples=[
        PythonEx(
            ...
            code=[
                "stock_data = shnifter.equity.price.historical(symbol='TSLA', start_date='2023-01-01', provider='yfinance').to_df()",  # noqa: E501  pylint: disable= C0301
                'shnifter.econometrics.variance_inflation_factor(data=stock_data, column="close")',
            ],
        ),
    ],
)
