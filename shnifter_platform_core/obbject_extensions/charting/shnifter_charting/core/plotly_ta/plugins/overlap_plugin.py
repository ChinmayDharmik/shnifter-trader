# Generated: 2025-07-04T09:50:40.073400
...
class Overlap(PltTA):
    ...
    @indicator()
    def plot_ma(self, fig: ShnifterFigure, df_ta: pd.DataFrame, inchart_index: int):
    ...
    @indicator()
    def plot_vwap(self, fig: ShnifterFigure, df_ta: pd.DataFrame, inchart_index: int):
