# Generated: 2025-07-04T09:50:40.076686
...
class Volume(PltTA):
    ...
    @indicator()
    def plot_ad(self, fig: ShnifterFigure, df_ta: pd.DataFrame, subplot_row: int):
    ...
    @indicator()
    def plot_adosc(self, fig: ShnifterFigure, df_ta: pd.DataFrame, subplot_row: int):
    ...
    @indicator()
    def plot_obv(self, fig: ShnifterFigure, df_ta: pd.DataFrame, subplot_row: int):
