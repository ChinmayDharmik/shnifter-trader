# Generated: 2025-07-04T09:50:40.075680
...
class Volatility(PltTA):
    ...
    @indicator()
    def plot_atr(self, fig: ShnifterFigure, df_ta: pd.DataFrame, subplot_row: int):
    ...
    @indicator()
    def plot_bbands(self, fig: ShnifterFigure, df_ta: pd.DataFrame, inchart_index: int):
    ...
    @indicator()
    def plot_donchian(self, fig: ShnifterFigure, df_ta: pd.DataFrame, inchart_index: int):
    ...
    @indicator()
    def plot_kc(self, fig: ShnifterFigure, df_ta: pd.DataFrame, inchart_index: int):
