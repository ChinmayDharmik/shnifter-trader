# Generated: 2025-07-04T09:50:40.070838
...
from shnifter_charting.core.config.shnifter_styles import PLT_FIB_COLORWAY
from shnifter_charting.core.shnifter_figure import ShnifterFigure
from shnifter_charting.core.plotly_ta.base import PltTA, indicator
...
class Custom(PltTA):
    ...
    @indicator()
    def plot_srlines(self, fig: ShnifterFigure, df_ta: pd.DataFrame):
    ...
    @indicator()
    def plot_fib(self, fig: ShnifterFigure, df_ta: pd.DataFrame):
