# Generated: 2025-07-04T09:50:40.074521
...
class Trend(PltTA):
    ...
    @indicator()
    def plot_adx(self, fig: ShnifterFigure, df_ta: pd.DataFrame, subplot_row: int):
    ...
    @indicator()
    def plot_aroon(self, fig: ShnifterFigure, df_ta: pd.DataFrame, subplot_row: int):
