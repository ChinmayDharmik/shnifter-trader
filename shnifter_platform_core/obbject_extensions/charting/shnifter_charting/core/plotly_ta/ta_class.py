# Generated: 2025-07-04T09:50:40.067728
...
from shnifter_charting.core.plotly_ta.base import PltTA
from shnifter_charting.core.plotly_ta.data_classes import ChartIndicators
from shnifter_charting.core.plotly_ta.ta_helpers import check_columns
...
if TYPE_CHECKING:
    import pandas as pd
    from shnifter_core.app.model.charts.charting_settings import ChartingSettings
...
class PlotlyTA(PltTA):
    ...
    plot(
        ...
        fig: Optional[ShnifterFigure] = None,
        symbol: Optional[str] = "",
        candles: bool = True,
        volume: bool = True,
    ) -> ShnifterFigure:
    ...
    >>> df = shnifter.equity.price.historical("SPY")
    >>> indicators = dict(
    ...
    >>> df2 = shnifter.equity.price.historical("AAPL")
    >>> fig2 = ta.plot(df2)
    >>> fig.show()
    >>> fig2.show()
    """
    ...
    def init_plot(self, symbol: str = "", candles: bool = True) -> ShnifterFigure:
        ...
        """
        fig = ShnifterFigure(charting_settings=self.charting_settings)
    ...
    def process_fig(self, fig: ShnifterFigure, volume_ticks_x: int = 7) -> ShnifterFigure:
        ...
        """
        new_subplot = ShnifterFigure(charting_settings=self.charting_settings)
