# Generated: 2025-07-04T09:50:40.054199
    ...
    def apply_style(self, style: Optional[str] = "") -> None:
        ...
        if self.plt_style and self.plotly_template:
            ...
            if "tables" in self.plt_styles_available:
                ...
                pio.templates["shnifter_tables"] = go.layout.Template(tables)
            try:
                pio.templates["shnifter"] = go.layout.Template(self.plotly_template)
            ...
            if style in ["dark", "white"]:
                pio.templates.default = f"plotly_{style}+shnifter"
                return

            pio.templates.default = "shnifter"
            self.mapbox_style = (
