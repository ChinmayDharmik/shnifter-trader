# Generated: 2025-07-04T09:50:40.058940
...
if TYPE_CHECKING:
    from shnifter_charting.core.plotly_ta.data_classes import ChartIndicators  # noqa
...
def to_chart(
    ...
    -------
    Tuple[ShnifterFigure, Dict[str, Any]]
        Tuple containing the ShnifterFigure and the plotly json representation of the chart.
    """
