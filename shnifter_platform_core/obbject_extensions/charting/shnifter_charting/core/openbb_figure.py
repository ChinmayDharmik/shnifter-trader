# Generated: 2025-07-04T09:50:40.057737
# Target: Shnifter Trader Platform with PySide6 and LLM integration
# Python Version: 3.13.2+

"""Shnifter Figure Class."""
...
from shnifter_charting.core.backend import PLOTLYJS_PATH, create_backend, get_backend
from shnifter_charting.core.config.shnifter_styles import (
    PLT_TBL_ROW_COLORS,
)
...
class ShnifterFigure(go.Figure):
    """Custom Figure class for Shnifter Trader.
    ...
    **kwargs
    ...
    Class Methods
    -------------
    create_subplots(rows: `int`, cols: `int`, **kwargs) -> `ShnifterFigure`
    ...
    to_subplot(subplot: `ShnifterFigure`, row: `int`, col: `int`, secondary_y: `bool`, ...)
    ...
    def to_subplot(
        ...
        **kwargs,
        ...
        subplot : `plotly.graph_objects.Figure`
            Figure object created with `ShnifterFigure.create_subplots` / `plotly.subplots.make_subplots`
        row : `int`
            Row number
        col : `int`
            Column number
    ...
    def _add_cmd_source(self, command_location: Optional[str] = "") -> None:
        """Set the watermark for Shnifter Trader."""
        if command_location:
