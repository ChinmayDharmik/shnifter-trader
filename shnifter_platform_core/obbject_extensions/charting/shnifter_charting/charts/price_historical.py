# Generated: 2025-07-04T09:50:40.047970
...
def price_historical(  # noqa: PLR0912
    **kwargs,
    ...
    from shnifter_charting.core.plotly_ta.ta_class import PlotlyTA  # noqa
    from shnifter_charting.core.chart_style import ChartStyle  # noqa
    from shnifter_charting.charts.helpers import (  # noqa
        calculate_returns,
        heikin_ashi,
        should_share_axis,
    ...
    if "data" in kwargs and isinstance(kwargs["data"], DataFrame):
        ...
        data = basemodel_to_df(
            kwargs["shnifterject_item"], index=kwargs.get("index", "date")  # type: ignore
        )
