# Generated: 2025-07-04T09:50:40.045967
...
def line_chart(  # noqa: PLR0912
    ...
    **kwargs,
    ...
    try:
        ...
        fig = ShnifterFigure(create_backend=True)
...
def bar_chart(  # noqa: PLR0912
    ...
    **kwargs,
    ...
    try:
        figure = ShnifterFigure()
    except Exception as _:
        figure = ShnifterFigure(create_backend=True)
