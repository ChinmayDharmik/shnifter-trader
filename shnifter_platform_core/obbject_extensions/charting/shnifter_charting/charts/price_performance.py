# Generated: 2025-07-04T09:50:40.048858
...
def price_performance(
    **kwargs,
) -> Tuple[Union["ShnifterFigure", "Figure"], Dict[str, Any]]:  # noqa: PLR0912
    ...
    if "data" in kwargs and isinstance(kwargs["data"], DataFrame):
        ...
        data = basemodel_to_df(
            kwargs["shnifterject_item"], index=kwargs.get("index", "symbol")  # type: ignore
        )
