# Generated: 2025-07-04T09:50:40.438302
...
from shnifter_core.app.logs.formatters.formatter_with_exceptions import (
    FormatterWithExceptions,
)
from shnifter_core.app.logs.handlers_manager import HandlersManager
from shnifter_core.app.logs.models.logging_settings import LoggingSettings
...
class LoggingService(metaclass=SingletonMeta):
    ...
    log(user_settings, system_settings, shnifterject, route, func, kwargs)
    ...
    _logger = logging.getLogger("shnifter.logging_service")
