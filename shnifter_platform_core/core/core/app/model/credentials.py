# Generated: 2025-07-04T09:50:40.441491
...
class CredentialsLoader:
    ...
    def from_shnifterject(self) -> None:
        """Load credentials from Shnifterject extensions."""
        for ext_name, ext in ExtensionLoader().shnifterject_objects.items():  # type: ignore[attr-defined]
            try:
