# Generated: 2025-07-04T09:50:40.447499
...
from shnifter_core.app.model.abstract.warning import Warning_
from shnifter_core.app.model.charts.chart import Chart
from shnifter_core.provider.abstract.annotated_result import AnnotatedResult
...
if TYPE_CHECKING:
    ...
    from shnifter_core.app.query import Query  # noqa
...
class Shnifterject(Tagged, Generic[T]):
    """Shnifter object."""
    ...
    def to_dataframe(  # noqa: PLR0912
        ...
        if self.results is None or not self.results:
            raise ShnifterError("Results not found.")
        ...
        try:
            ...
            if df is None:
                raise ShnifterError("Unsupported data format.")
            ...
            raise ShnifterError(f"An unexpected error occurred: {ex}") from ex
    ...
    def show(self, **kwargs: Any) -> None:
        ...
        if not self.chart or not self.chart.fig:
            raise ShnifterError("Chart not found.")
        show_function: Callable = getattr(self.chart.fig, "show")
        show_function(**kwargs)

    @classmethod
    async def from_query(cls, query: "Query") -> "Shnifterject":
        """Create Shnifterject from query.
        ...
        Returns
        -------
        Shnifterject[ResultsType]
            Shnifterject with results.
        """
