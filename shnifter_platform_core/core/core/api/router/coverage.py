# Generated: 2025-07-04T09:50:40.499956
...
from shnifter_core.api.dependency.coverage import get_command_map, get_provider_interface
...
async def get_commands_model_map(
    ...
    for command in command_map.commands_model:
        ...
        for provider in providers:
            ...
            if shnifter_info := new_command.get("shnifter", {}):
                for key in list(new_command):
                    if key == "response_schema_name":
                        continue

                    if shnifter_params := shnifter_info.get("QueryParams", {}).get(
                        "fields", {}
                    ):
                    ...
                    if shnifter_data := shnifter_info.get("Data", {}).get("fields", {}):
                        old_fields = new_command[key]["Data"].get("fields", {})
                        new_command[key]["Data"]["fields"] = {**shnifter_data, **old_fields}
        _ = new_command.pop("shnifter")
