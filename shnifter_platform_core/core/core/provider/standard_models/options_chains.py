# Generated: 2025-07-04T09:50:40.380556
...
from shnifter_core.provider.utils.options_chains_properties import OptionsChainsProperties
...
class OptionsChainsData(OptionsChainsProperties):
    ...
    ------
    ShnifterError
        ShnifterError will raise when accessing properties and methods if required, specific, data was not found.
    """
