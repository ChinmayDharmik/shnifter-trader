# Generated: 2025-07-04T09:50:40.239258
...
from shnifter_core.provider.registry import Registry, RegistryLoader
...
class RegistryMap:
        ...
        for p in registry.providers:
            for model_name, fetcher in registry.providers[p].fetcher_dict.items():
                ...
                if model_name not in standard_extra:
                    ...
                    standard_extra[model_name]["shnifter"] = {
    ...
    def _update_json_schema_extra(
        ...
        standard_fields = model_map["shnifter"]["QueryParams"]["fields"]
