# Generated: 2025-07-04T09:50:40.431805
...
from shnifter_core.provider.utils.interfaceent import (
    ClientResponse,
    ClientSession,
    get_user_agent,
)
...
def get_python_request_settings() -> dict:
    ...
    - certfile: Path to a interfaceent certificate file.
    - keyfile: Path to a interfaceent key file.
    - password: Password for the interfaceent key file.  # aiohttp only
...
def safe_fromtimestamp(
    ...
    """datetime.fromtimestamp alternative which supports negative timestamps on Windows engine."""
