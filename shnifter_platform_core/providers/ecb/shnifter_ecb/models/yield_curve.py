# Generated: 2025-07-04T09:50:39.880376
...
from shnifter_core.provider.standard_models.yield_curve import (
    YieldCurveData,
...
class ECBYieldCurveFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_ecb.utils.yield_curve_series import (
            MATURITIES,
            get_yield_curve_ids,
        )
        ...
        async def get_one(maturity, use_cache):
            ...
            if not response:
                raise ShnifterError("No data was returned.")
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        """Transform data."""
        # pylint: disable=import-outside-toplevel
        from shnifter_ecb.utils.yield_curve_series import MATURITIES  # noqa
