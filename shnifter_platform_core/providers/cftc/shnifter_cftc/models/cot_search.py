# Generated: 2025-07-04T09:50:39.901091
...
from shnifter_core.provider.standard_models.cot_search import (
    CotSearchData,
...
class CftcCotSearchFetcher(Fetcher[CftcCotSearchQueryParams, List[CftcCotSearchData]]):
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        assets_path = Path(str(files("shnifter_cftc").joinpath("assets")))
