# Generated: 2025-07-04T09:50:39.893345
...
from shnifter_deribit.utils.helpers import DERIBIT_OPTIONS_SYMBOLS
...
class DeribitOptionsChainsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        import json
        import websockets
        from shnifter_deribit.utils.helpers import get_options_symbols
        from pandas import to_datetime
        from websockets.asyncio.interfaceent import connect
        ...
        if messages and not results:
            raise ShnifterError(", ".join(messages))
