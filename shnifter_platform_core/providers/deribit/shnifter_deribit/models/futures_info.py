# Generated: 2025-07-04T09:50:39.890769
...
from shnifter_core.provider.standard_models.futures_info import (
    FuturesInfoData,
...
class DeribitFuturesInfoQueryParams(FuturesInfoQueryParams):
    ...
    def _validate_symbol(cls, v):
        ...
        from shnifter_deribit.utils.helpers import (
            get_futures_symbols,
...
class DeribitFuturesInfoFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
        import asyncio  # noqa
        from shnifter_core.provider.utils.errors import EmptyDataError, ShnifterError
        from shnifter_deribit.utils.helpers import get_ticker_data
        ...
        try:
            ...
            raise ShnifterError(f"Error fetching data: {e}") from e
