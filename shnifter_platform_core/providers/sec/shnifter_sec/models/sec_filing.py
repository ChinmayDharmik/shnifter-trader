# Generated: 2025-07-04T09:50:39.557885
...
class SecBaseFiling(Data):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, url: str, use_cache: bool = True):
        ...
        from shnifter_core.provider.utils.helpers import run_async
    ...
    async def _adownload_file(url, use_cache: bool = True):
        ...
        from shnifter_sec.utils.definitions import SEC_HEADERS
        from shnifter_sec.utils.helpers import sec_callback
    ...
    def download_file(url, read_html_table: bool = False, use_cache: bool = True):
        ...
        # pylint: disable=import-outside-toplevel
        from shnifter_core.provider.utils.helpers import run_async  # noqa
