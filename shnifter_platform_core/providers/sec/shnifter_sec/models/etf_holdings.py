# Generated: 2025-07-04T09:50:39.548144
...
from shnifter_core.provider.standard_models.etf_holdings import (
    EtfHoldingsData,
...
class SecEtfHoldingsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from aiohttp_interfaceent_cache.session import CachedSession  # noqa
        ...
        from shnifter_sec.utils.helpers import HEADERS, get_nport_candidates  # noqa
        ...
        if filing_candidates.empty:
            raise ShnifterError(f"No N-Port records found for {query.symbol}.")
