# Generated: 2025-07-04T09:50:39.550029
...
class SecHtmFileFetcher(Fetcher[SecHtmFileQueryParams, SecHtmFileData]):
    ...
    def transform_query(params: dict[str, Any]) -> SecHtmFileQueryParams:
        ...
        if not params.get("url"):
            raise ShnifterError(ValueError("Please enter a URL."))
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_sec.models.sec_filing import SecBaseFiling
    ...
    def transform_data(
        ...
        if not data or not data.get("content"):
            raise ShnifterError("Failed to extract HTM file data.")
