# Generated: 2025-07-04T09:50:39.565254
...
from shnifter_sec.utils.definitions import (
    FISCAL_PERIODS,
    FISCAL_PERIODS_DICT,
    HEADERS,
    SHARES_FACTS,
...
from shnifter_sec.utils.helpers import get_all_companies, symbol_map
    ...
    try:
        ...
        if url.endswith("I.json"):
            ...
            try:
                ...
                raise ShnifterError(message) from e
