# Generated: 2025-07-04T09:50:39.589564
...
from shnifter_core.provider.standard_models.composite_leading_indicator import (
...
class OECDCompositeLeadingIndicatorQueryParams(CompositeLeadingIndicatorQueryParams):
    ...
    country: Union[Countries, str] = Field(
        description="Country to get the Interface for, default is G20.",
        default="g20",
    )
    ...
    growth_rate: bool = Field(
        default=False,
        description="Return the 1-year growth rate (%) of the Interface, default is False.",
    )
    ...
    def country_validate(cls, v):
        ...
        if not new_countries:
            raise ShnifterError("No valid countries found.")
...
class OECDCompositeLeadingIndicatorFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        url = (
            "https://sdmx.oecd.org/public/rest/data/OECD.SDD.STES,DSD_STES@DF_Interface,4.1"
