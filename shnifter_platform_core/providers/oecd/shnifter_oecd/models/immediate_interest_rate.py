# Generated: 2025-07-04T09:50:39.596742
...
from shnifter_core.provider.standard_models.immediate_interest_rate import (
...
from shnifter_oecd.utils.constants import CODE_TO_COUNTRY_IR, COUNTRY_TO_CODE_IR
...
class OECDImmediateInterestRateFetcher(
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_oecd.utils.helpers import oecd_date_to_python_date  # noqa
        from pandas import read_csv  # noqa
        from shnifter_core.provider.utils.helpers import make_request  # noqa
