# Generated: 2025-07-04T09:50:39.600553
...
from shnifter_core.provider.standard_models.unemployment import (
    UnemploymentData,
...
from shnifter_oecd.utils.constants import (
...
class OECDUnemploymentFetcher(
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_oecd.utils import helpers  # noqa
        ...
        if response.status_code != 200:
            raise ShnifterError(f"Error: {response.status_code} -> {response.text}")
