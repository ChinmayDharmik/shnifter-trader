# Generated: 2025-07-04T09:50:39.599575
...
from shnifter_core.provider.standard_models.short_term_interest_rate import (
    STIRData,
    STIRQueryParams,
)
...
class OECDSTIRFetcher(Fetcher[OECDSTIRQueryParams, List[OECDSTIRData]]):
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
        from shnifter_oecd.utils import helpers
