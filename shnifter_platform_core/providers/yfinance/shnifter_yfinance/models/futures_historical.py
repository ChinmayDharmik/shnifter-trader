# Generated: 2025-07-04T09:50:39.446800
...
from shnifter_yfinance.utils.references import INTERVALS_DICT, MONTHS
...
class YFinanceFuturesHistoricalFetcher(
    ...
    def transform_query(params: Dict[str, Any]) -> YFinanceFuturesHistoricalQueryParams:
        ...
        from shnifter_yfinance.utils.helpers import get_futures_data
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
        from shnifter_yfinance.utils.helpers import yf_download
