# Generated: 2025-07-04T09:50:39.435209
...
from shnifter_core.provider.standard_models.available_indices import (
    AvailableIndicesData,
    AvailableIndicesQueryParams,
)
from shnifter_yfinance.utils.references import INDICES
...
class YFinanceAvailableIndicesData(AvailableIndicesData):
    ...
    code: str = Field(
        description="ID code for keying the index in the Shnifter Trader."
    )
