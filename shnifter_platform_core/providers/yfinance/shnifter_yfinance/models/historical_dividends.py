# Generated: 2025-07-04T09:50:39.449354
...
from shnifter_core.provider.standard_models.historical_dividends import (
        ...
        **kwargs: Any,
        ...
        try:
            ...
            if isinstance(ticker, List) and not ticker or ticker.empty:  # type: ignore
                raise ShnifterError(f"No dividend data found for {query.symbol}")
        except Exception as e:
            raise ShnifterError(f"Error getting data for {query.symbol}: {e}") from e
