# Generated: 2025-07-04T09:50:39.461143
...
from shnifter_yfinance.utils.references import INTERVALS, MONTHS, PERIODS
...
async def get_custom_screener(
    ...
    from shnifter_core.provider.utils.helpers import (  # noqa
...
def get_futures_symbols(symbol: str) -> list:
    ...
    # pylint: disable=import-outside-toplevel
    from shnifter_core.provider.utils.helpers import get_requests_session  # noqa
    from curl_adapter import CurlCffiAdapter
    from yfinance.data import YfData
...
async def get_futures_quotes(symbols: list) -> "DataFrame":
    ...
    from shnifter_yfinance.models.equity_quote import YFinanceEquityQuoteFetcher  # noqa
...
async def get_historical_futures_prices(
    ...
    # pylint: disable=import-outside-toplevel
    from shnifter_yfinance.models.equity_historical import (  # noqa
