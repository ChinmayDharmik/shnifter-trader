# Generated: 2025-07-04T09:50:39.577835
...
from shnifter_core.provider.standard_models.currency_snapshots import (
...
class PolygonCurrencySnapshotsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        if results.get("status") != "OK":  # type: ignore[union-attr]
            raise ShnifterError(f"Error: {results.get('status')}")  # type: ignore[union-attr]
    ...
    def transform_data(  # pylint: disable=too-many-locals, too-many-statements
        ...
        **kwargs: Any,
        ...
        from shnifter_core.provider.utils.helpers import safe_fromtimestamp  # noqa
