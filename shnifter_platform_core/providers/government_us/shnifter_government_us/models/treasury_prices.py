# Generated: 2025-07-04T09:50:39.697874
...
from shnifter_core.provider.standard_models.treasury_prices import (
    TreasuryPricesData,
...
class GovernmentUSTreasuryPricesFetcher(
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_government_us.utils.helpers import get_random_agent
        ...
        if r.status_code != 200:
            raise ShnifterError("Error with the request: " + str(r.status_code))

        if r.encoding != "ISO-8859-1":
            raise ShnifterError(f"Expected ISO-8859-1 encoding but got: {r.encoding}")
