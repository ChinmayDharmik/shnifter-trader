# Generated: 2025-07-04T09:50:39.846982
...
class SomaHoldings:
    ...
    async def get_as_of_dates(self) -> List:
        ...
        if not dates:
            raise ShnifterError("Error requesting dates. Please try again later.")
        return dates
    ...
    async def get_release_log(
        ...
        if not release_log:
            raise ShnifterError("No data found. Try again later.")
