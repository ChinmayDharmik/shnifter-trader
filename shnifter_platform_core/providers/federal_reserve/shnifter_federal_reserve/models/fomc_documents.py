# Generated: 2025-07-04T09:50:39.837460
...
from shnifter_federal_reserve.utils.fomc_documents import FomcDocumentType
...
class FederalReserveFomcDocumentsData(Data):
    ...
    content: Any = Field(
        ...
        + " The endpoint response will not be an Shnifterject.results object, but the content directly.",
    )
...
class FederalReserveFomcDocumentsFetcher(
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_federal_reserve.utils.fomc_documents import (
