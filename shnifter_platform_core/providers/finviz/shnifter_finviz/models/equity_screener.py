# Generated: 2025-07-04T09:50:39.816478
...
from shnifter_core.provider.standard_models.equity_screener import (
    EquityScreenerData,
...
from shnifter_finviz.utils.screener_helper import (
    EXCHANGE_MAP,
    INDEX_MAP,
    INDUSTRY_MAP,
    MARKET_CAP_MAP,
...
class FinvizEquityScreenerQueryParams(EquityScreenerQueryParams):
    ...
    preset: Optional[str] = Field(
        ...
        + " Presets (.ini text files) can be created and modified in the '~/ShnifterUserData/finviz/presets' directory."
    ...
    def validate_filters_dict(cls, v):
        ...
        if isinstance(v, str):
            ...
            try:
                ...
                raise ShnifterError(f"Invalid JSON format for 'filters_dict': {e}") from e
