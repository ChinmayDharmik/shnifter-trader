# Generated: 2025-07-04T09:50:39.680596
...
from shnifter_core.provider.standard_models.maritime_chokepoint_volume import (
    MaritimeChokePointVolumeData,
    MaritimeChokePointVolumeQueryParams,
)
from shnifter_imf.utils.constants import CHOKEPOINTS_NAME_TO_ID, ChokepointsNames
        ...
        **kwargs: Any,
        ...
        for task_result in task_results:
            if isinstance(task_result, Exception):
                raise ShnifterError(task_result)

        if not results:
            raise ShnifterError("The response was returned empty with no error message.")
