# Generated: 2025-07-04T09:50:39.677440
...
from shnifter_core.provider.standard_models.direction_of_trade import (
    DirectionOfTradeData,
    DirectionOfTradeQueryParams,
)
from shnifter_core.provider.utils.errors import EmptyDataError
from shnifter_imf.utils.dot_helpers import (
    load_country_map,
...
class ImfDirectionOfTradeFetcher(
    ...
    def transform_query(params: dict[str, Any]) -> ImfDirectionOfTradeQueryParams:
        ...
        if countries == counterparts:
            raise ShnifterError("The 'country' and 'counterpart' cannot be the same.")
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        if not series:
            raise ShnifterError(f"No time series data found -> {url} -> {response}")
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        """Transform the data."""
        # pylint: disable=import-outside-toplevel
        from shnifter_imf.utils.constants import UNIT_MULTIPLIERS_MAP  # noqa
