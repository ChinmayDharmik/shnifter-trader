# Generated: 2025-07-04T09:50:39.676382
...
from shnifter_core.provider.standard_models.available_indicators import (
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise ShnifterError(f"Failed to load IMF symbols static file: {e}") from e
