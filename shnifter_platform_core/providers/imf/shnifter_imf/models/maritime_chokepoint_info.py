# Generated: 2025-07-04T09:50:39.679490
...
from shnifter_core.provider.standard_models.maritime_chokepoint_info import (
...
class ImfMaritimeChokePointInfoQueryParams(MaritimeChokePointInfoQueryParams):
    ...
    theme: Optional[Literal["dark", "light"]] = Field(
        ...
        + " Only valid if `shnifter-charting` is installed and `chart` parameter is set to `true`."
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        if not data or "features" not in data:
            raise ShnifterError("No data found in the response.")
