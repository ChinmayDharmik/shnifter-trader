# Generated: 2025-07-04T09:50:39.678529
...
from shnifter_core.provider.standard_models.economic_indicators import (
...
from shnifter_imf.utils.irfcl_helpers import (
...
class ImfEconomicIndicatorsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_imf.utils.fsi_helpers import _get_fsi_data  # noqa
        from shnifter_imf.utils.irfcl_helpers import _get_irfcl_data
        ...
        try:
            ...
            except (EmptyDataError, ShnifterError) as e:
                if new_symbols_fsi:
                    exceptions.append(
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        if len(df) == 0:
            raise ShnifterError("The data has a length of 0.")
