# Generated: 2025-07-04T09:50:39.686912
...
def validate_symbols(symbols) -> str:
    ...
    from shnifter_imf.utils.constants import FSI_PRESETS
...
async def _get_fsi_data(**kwargs) -> list[dict]:  # noqa:PLR0912
    ...
    from shnifter_imf.utils.irfcl_helpers import load_country_to_code_map
