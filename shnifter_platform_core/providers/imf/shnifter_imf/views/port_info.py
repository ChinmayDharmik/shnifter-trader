# Generated: 2025-07-04T09:50:39.692759
# Target: Shnifter Trader Platform with PySide6 and LLM integration
# Python Version: 3.13.2+

"""Plotting functions for IMF Maritime Chokepoint Information"""

from shnifter_imf.models.port_info import ImfPortInfoData
...
def plot_port_info_map(data: list[ImfPortInfoData]):
    ...
    try:
        ...
        raise ShnifterError(
            "Could not import Charting modules. Install with `pip install shnifter-charting`."
            + f" -> {e}"
        ) from e
    ...
    if (
        ...
        raise ShnifterError("Invalid data format. Expected a list of ImfPortInfoData.")
    if len(data) == 0:
        raise ShnifterError("No data to plot.")
    ...
    return ShnifterFigure(fig).show(external=True)
