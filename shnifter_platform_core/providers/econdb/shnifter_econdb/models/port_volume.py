# Generated: 2025-07-04T09:50:39.868437
...
class EconDbPortVolumeData(PortVolumeData):
    ...
    export_dwell_time: Optional[float] = Field(
        ...
        + " enters the trader gates until it is loaded on a vessel."
    ...
    import_dwell_time: Optional[float] = Field(
        ...
        + " from a vessel until it exits the trader gates."
...
class EconDbPortVolumeFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        url = "https://www.econdb.com/static/shnifter/shipping.json"

        try:
            response = await amake_request(url)
        except Exception as e:
            raise ShnifterError("There was an error with the HTTP request") from e
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        """Transform the data."""
        # pylint: disable=import-outside-toplevel
        from shnifter_econdb.utils.helpers import COUNTRY_MAP
