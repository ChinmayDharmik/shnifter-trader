# Generated: 2025-07-04T09:50:39.863844
...
class EconDbEconomicIndicatorsQueryParams(EconomicIndicatorsQueryParams):
    ...
    def validate_countries(cls, v):
        ...
        from shnifter_econdb.utils import helpers
        ...
        if v:
            ...
            if len(country) == 0:
                raise ShnifterError("No valid countries were supplied.")
            return ",".join(country)
        return None
...
class EconDbEconomicIndicatorsFetcher(
    ...
    async def aextract_data(  # pylint: disable=R0914.R0912,R0915
        ...
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
        from shnifter_econdb.utils import helpers
        from shnifter_econdb.utils.main_indicators import get_main_indicators
        ...
        if not new_symbols:
            ...
            raise ShnifterError(error_message)
