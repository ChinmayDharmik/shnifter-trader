# Generated: 2025-07-04T09:50:39.869483
...
from shnifter_econdb.utils.yield_curves import COUNTRIES_DICT, COUNTRIES_LIST
    ...
    async def aextract_data(  # pylint: disable=R0914.R0912,R0915
        ...
        **kwargs: Any,
        ...
        if not results and messages:
            msg_str = "\n".join(messages)
            raise ShnifterError(msg_str)

        if not results and not messages:
            raise ShnifterError("Unexpected outcome -> All requests were returned empty.")
