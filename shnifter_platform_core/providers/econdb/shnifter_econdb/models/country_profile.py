# Generated: 2025-07-04T09:50:39.862071
...
from shnifter_core.provider.standard_models.country_profile import (
    CountryProfileData,
...
class EconDbCountryProfileQueryParams(CountryProfileQueryParams):
    ...
    def validate_country(cls, v):
        ...
        from shnifter_econdb.utils.helpers import (
            COUNTRY_GROUPS,
            COUNTRY_MAP,
...
class EconDbCountryProfileFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
        import asyncio  # noqa
        from shnifter_econdb.utils.helpers import get_context, parse_context  # noqa
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        """Transform the data."""
        # pylint: disable=import-outside-toplevel
        from shnifter_econdb.utils.helpers import PROFILE_ORDER
