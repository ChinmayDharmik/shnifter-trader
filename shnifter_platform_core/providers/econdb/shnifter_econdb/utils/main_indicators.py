# Generated: 2025-07-04T09:50:39.872900
...
from shnifter_econdb.utils.helpers import COUNTRY_MAP, THREE_LETTER_ISO_MAP
...
async def get_main_indicators(  # pylint: disable=R0913,R0914,R0915
    ...
    if len(country) == 3:
        ...
        if not country:
            raise ShnifterError(f"Error: Invalid country code -> {country}")
