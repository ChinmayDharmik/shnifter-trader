# Generated: 2025-07-04T09:50:39.828747
...
from shnifter_core.provider.standard_models.equity_short_interest import (
    ShortInterestData,
...
class FinraShortInterestFetcher(
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        import sqlite3  # noqa
        from shnifter_finra.utils.data_storage import get_db_path, prepare_data  # noqa
