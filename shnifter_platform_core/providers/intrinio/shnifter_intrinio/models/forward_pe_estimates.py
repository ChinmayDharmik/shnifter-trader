# Generated: 2025-07-04T09:50:39.649193
...
from shnifter_core.provider.standard_models.forward_pe_estimates import (
...
class IntrinioForwardPeEstimatesFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_intrinio.utils.helpers import response_callback
            ...
            try:
                ...
                for result in gather_results:
                    if isinstance(result, UnauthorizedError):
                        raise result
                    if isinstance(result, ShnifterError):
                        raise result
        ...
        async def fetch_callback(response, session):
            ...
            if error:
                ...
                raise ShnifterError(f"Error: {error} -> {message}")
