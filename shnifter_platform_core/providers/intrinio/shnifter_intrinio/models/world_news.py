# Generated: 2025-07-04T09:50:39.668699
...
from shnifter_core.provider.standard_models.world_news import (
    WorldNewsData,
    WorldNewsQueryParams,
)
from shnifter_core.provider.utils.errors import EmptyDataError, UnauthorizedError
from shnifter_intrinio.utils.references import IntrinioCompany, IntrinioSecurity
...
class IntrinioWorldNewsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_core.provider.utils.helpers import amake_request, get_querystring
        from shnifter_intrinio.utils.helpers import get_data
        ...
        async def callback(response, session):
            ...
            if isinstance(result, dict) and "error" in result:
                ...
                raise ShnifterError(f"Error in Intrinio request -> {result}")
