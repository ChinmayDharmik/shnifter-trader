# Generated: 2025-07-04T09:50:39.646219
...
from shnifter_core.provider.standard_models.financial_ratios import (
    FinancialRatiosData,
    FinancialRatiosQueryParams,
)
from shnifter_core.provider.utils.descriptions import QUERY_DESCRIPTIONS
from shnifter_core.provider.utils.helpers import ClientResponse, amake_requests
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        if query.period in ["quarter", "annual"]:
            ...
            raise ShnifterError(f"Period '{query.period}' not supported.")
