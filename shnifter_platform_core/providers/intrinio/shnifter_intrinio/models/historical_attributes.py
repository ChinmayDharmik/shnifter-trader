# Generated: 2025-07-04T09:50:39.652096
...
from shnifter_core.provider.standard_models.historical_attributes import (
        ...
        **kwargs: Any,
        ...
        async def callback(
            ...
            if message := init_response.get(  # type: ignore
                ...
                warnings.warn(message=str(message), category=ShnifterWarning)
                return []
            ...
            while next_page:
                ...
                if message := response_data.get("error") or response_data.get(  # type: ignore
                    ...
                    warnings.warn(message=message, category=ShnifterWarning)
                    return []
