# Generated: 2025-07-04T09:50:39.662830
...
from shnifter_core.provider.standard_models.options_snapshots import (
...
class IntrinioOptionsSnapshotsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise ShnifterError("Could not fetch data from Intrinio.") from exc
        ...
        if not urls:
            raise ShnifterError("No snapshots found.")
        ...
        async def get_csv(url) -> DataFrame:
            ...
            try:
                ...
                try:
                    ...
                    raise ShnifterError("Could not read file from URL.") from exc
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        df = data
        if df.empty:
            raise ShnifterError("Empty CSV file")
        COL_MAP = {
