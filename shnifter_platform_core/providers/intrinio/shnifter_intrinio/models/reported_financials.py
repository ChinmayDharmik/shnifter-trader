# Generated: 2025-07-04T09:50:39.665847
...
from shnifter_core.provider.standard_models.reported_financials import (
...
class IntrinioReportedFinancialsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_intrinio.utils.helpers import get_data_one
        ...
        if ids == []:
            raise ShnifterError("No reports found.")
