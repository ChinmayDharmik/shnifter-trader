# Generated: 2025-07-04T09:50:39.644167
...
from shnifter_core.provider.standard_models.etf_search import (
    EtfSearchData,
    EtfSearchQueryParams,
)
from shnifter_core.provider.utils.errors import EmptyDataError
from shnifter_intrinio.utils.references import ETF_EXCHANGES
        ...
        **kwargs: Any,
        ...
        async def response_callback(response: ClientResponse, session: ClientSession):
            ...
            if results.get("messages"):  # type: ignore
                ...
                raise ShnifterError(str(messages))
