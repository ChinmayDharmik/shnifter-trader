# Generated: 2025-07-04T09:50:39.661700
...
from shnifter_core.provider.utils.errors import ShnifterError
...
class IntrinioOptionsChainsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_intrinio.utils.helpers import (
            get_data_many,
            get_weekday,
            response_callback,
        )
        ...
        if not results:
            raise ShnifterError(f"No data found for the given symbol: {query.symbol}")
