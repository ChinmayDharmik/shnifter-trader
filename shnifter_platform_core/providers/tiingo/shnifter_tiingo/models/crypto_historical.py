# Generated: 2025-07-04T09:50:39.520631
...
from shnifter_core.provider.standard_models.crypto_historical import (
...
class TiingoCryptoHistoricalFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Optional[Any],
        ...
        except (EmptyDataError, ShnifterError, UnauthorizedError) as e:
            raise e from e
