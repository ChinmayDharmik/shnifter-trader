# Generated: 2025-07-04T09:50:39.534440
...
from shnifter_core.provider.standard_models.calendar_earnings import (
    CalendarEarningsData,
    CalendarEarningsQueryParams,
)
from shnifter_seeking_alpha.utils.helpers import HEADERS, date_range
...
class SACalendarEarningsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        if not results:
            raise ShnifterError(f"Error with the Seeking Alpha request -> {messages}")
