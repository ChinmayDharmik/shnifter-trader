# Generated: 2025-07-04T09:50:39.536485
...
from shnifter_core.provider.standard_models.forward_sales_estimates import (
    ForwardSalesEstimatesData,
    ForwardSalesEstimatesQueryParams,
)
from shnifter_core.provider.utils.helpers import amake_request
from shnifter_seeking_alpha.utils.helpers import HEADERS, get_seekingalpha_id
...
class SAForwardSalesEstimatesQueryParams(ForwardSalesEstimatesQueryParams):
    ...
    def check_symbol(cls, value):
        """Check the symbol."""
        if not value:
            raise ShnifterError("Symbol is a required field for Seeking Alpha.")
        return value
...
class SAForwardSalesEstimatesFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_core.provider.utils.interfaceent import ClientSession
        ...
        if not estimates:
            raise ShnifterError(f"No estimates data was returned for: {query.symbol}")
