# Generated: 2025-07-04T09:50:39.851636
...
class EiaPetroleumStatusReportFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        # pylint: disable=import-outside-toplevel
        from shnifter_us_eia.utils.helpers import download_excel_file
        ...
        try:
            ...
            raise ShnifterError(f"Error extracting data -> {e}") from e
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise ShnifterError(f"Error transforming the data -> {e}") from e
