# Generated: 2025-07-04T09:50:39.852756
...
from shnifter_core.provider.standard_models.short_term_energy_outlook import (
...
class EiaShortTermEnergyOutlookFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_us_eia.utils.helpers import response_callback
        ...
        try:
            ...
            raise ShnifterError(f"Error fetching data from the EIA API -> {e}") from e
