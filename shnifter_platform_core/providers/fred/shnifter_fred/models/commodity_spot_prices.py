# Generated: 2025-07-04T09:50:39.708336
...
from shnifter_core.provider.standard_models.commodity_spot_prices import (
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise ShnifterError(f"Failed to fetch data from FRED API: {e}") from e
