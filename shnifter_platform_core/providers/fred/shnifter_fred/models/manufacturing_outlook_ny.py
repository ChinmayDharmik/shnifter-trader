# Generated: 2025-07-04T09:50:39.718503
...
from shnifter_core.provider.standard_models.manufacturing_outlook_texas import (
...
class FredManufacturingOutlookNYFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        if not ids:
            raise ShnifterError("No valid topic selected. Please select a valid topic.")
