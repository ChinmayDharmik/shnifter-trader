# Generated: 2025-07-04T09:50:39.727278
...
from shnifter_core.provider.standard_models.fred_release_table import (
    ReleaseTableData,
...
class FredReleaseTableFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        if not release_info:
            raise ShnifterError(f"No release information found for, {query.release_id}.")
