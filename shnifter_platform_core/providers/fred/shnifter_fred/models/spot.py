# Generated: 2025-07-04T09:50:39.734248
...
from shnifter_core.provider.standard_models.spot import (
    SpotRateData,
    SpotRateQueryParams,
)
...
class FREDSpotRateFetcher(
    ...
    def extract_data(
        ...
        **kwargs: Any
        ...
        from shnifter_fred.utils.fred_base import Fred
        ...
        if any(1 > m > 100 for m in maturity):
            raise ShnifterError("Maturity must be between 1 and 100")
