# Generated: 2025-07-04T09:50:39.728335
...
from shnifter_core.provider.standard_models.retail_prices import (
    RetailPricesData,
...
class FredRetailPricesFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        resource_path = files("shnifter_fred.utils").joinpath(f"{region}.json")
