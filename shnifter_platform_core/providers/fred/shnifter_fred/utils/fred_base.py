# Generated: 2025-07-04T09:50:39.740726
...
from shnifter_core.provider import helpers
...
class Fred:
    ...
    def get_series(
        ...
        **kwargs,
        ...
        Code copied from: https://gitcore.com/mortada/fredapi/blob/master/fredapi/fred.py
        ...
        if root is None:
            raise ShnifterError("No data exists for series id: " + series_id)
        if "error_code" in root and "error_message" in root and root["error_message"]:
            raise ShnifterError(root["error_message"])
