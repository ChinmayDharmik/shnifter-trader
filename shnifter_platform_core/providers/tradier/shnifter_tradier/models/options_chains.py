# Generated: 2025-07-04T09:50:39.481695
...
from shnifter_core.provider.standard_models.options_chains import (
    OptionsChainsData,
    OptionsChainsQueryParams,
)
from shnifter_core.provider.utils.errors import EmptyDataError
from shnifter_tradier.utils.constants import OPTIONS_EXCHANGES, STOCK_EXCHANGES
...
class TradierOptionsChainsFetcher(
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_tradier.models.equity_quote import TradierEquityQuoteFetcher  # noqa
        ...
        if expirations == []:
            raise ShnifterError(f"No expiration dates found for {query.symbol}")
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_core.provider.utils.helpers import safe_fromtimestamp
