# Generated: 2025-07-04T09:50:39.615944
...
from shnifter_core.provider.standard_models.top_retail import (
    TopRetailData,
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        if response.status_code != 200:
            ...
            raise ShnifterError(f"Failed to get data from Nasdaq -> {reason}")
