# Generated: 2025-07-04T09:50:39.613094
...
class NasdaqEquityScreenerFetcher(
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_core.provider.utils.helpers import get_querystring, make_request
        from shnifter_nasdaq.utils.helpers import get_headers
        ...
        try:
            ...
            raise ShnifterError(f"Failed to get data from Nasdaq -> {error}") from error
