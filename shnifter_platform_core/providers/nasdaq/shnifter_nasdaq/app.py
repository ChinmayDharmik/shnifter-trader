# Generated: 2025-07-04T09:50:39.604665
# Target: Shnifter Trader Platform with PySide6 and LLM integration
# Python Version: 3.13.2+

"""Shnifter Workspace Application.
...
```bash
shnifter-api --app shnifter_nasdaq.app:main --factory
```

Then navigate to the Shnifter Workspace and add the server as a backend data source.

Open the server's URL in your browser for more information on connecting to the Shnifter Workspace.
"""
