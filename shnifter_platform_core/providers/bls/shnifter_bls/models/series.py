# Generated: 2025-07-04T09:50:39.930279
...
from shnifter_core.provider.standard_models.bls_series import (
    SeriesData,
    SeriesQueryParams,
)
...
class BlsSeriesFetcher(Fetcher[BlsSeriesQueryParams, List[BlsSeriesData]]):
    ...
    async def aextract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_bls.utils.helpers import get_bls_timeseries
        ...
        if not results.get("data"):
            if messages:
                raise ShnifterError(",".join(set(messages)))
