# Generated: 2025-07-04T09:50:39.928861
...
from shnifter_bls.utils.constants import SURVEY_CATEGORIES, SURVEY_CATEGORY_NAMES
...
from shnifter_core.provider.standard_models.bls_search import (
    SearchData,
    SearchQueryParams,
)
...
class BlsSearchFetcher(Fetcher[BlsSearchQueryParams, List[BlsSearchData]]):
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        from shnifter_bls.utils.helpers import open_asset
