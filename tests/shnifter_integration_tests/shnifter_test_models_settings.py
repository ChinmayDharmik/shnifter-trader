...
from shnifter_interface.models.settings import Settings
...
def test_default_values():
    ...
    assert fields["SHOW_MSG_ShnifterJECT_REGISTRY"].default is False
    assert fields["TIMEZONE"].default == "America/New_York"
    assert fields["FLAIR"].default == ":shnifter"
    assert fields["PREVIOUS_USE"].default is False
    assert fields["N_TO_KEEP_ShnifterJECT_REGISTRY"].default == 10
    assert fields["N_TO_DISPLAY_ShnifterJECT_REGISTRY"].default == 5
    ...
    assert fields["HUB_URL"].default == "https://my.shnifter.co"
    assert fields["BASE_URL"].default == "https://payments.shnifter.co"
...
@patch(
    "shnifter_interface.models.settings.dotenv_values",
    return_value={"SHNIFTER_TEST_MODE": "True", "SHNIFTER_VERSION": "2.0.0"},
)
...
@patch("shnifter_interface.models.settings.set_key")
@patch(
    "shnifter_interface.models.settings.open",
