...
import pytest
from shnifter_interface.controllers.script_parser import (
    match_and_return_shnifter_keyword_date,
    parse_shnifter_script,
)
...
def test_is_reset(command, expected):
    ...
    from shnifter_interface.controllers.script_parser import is_reset

    assert is_reset(command) == expected


def test_match_and_return_shnifter_keyword_date():
    """Test the match_and_return_shnifter_keyword_date function."""
    keyword = "$LASTFRIDAY"
    result = match_and_return_shnifter_keyword_date(keyword)
    expected = ""
...
def test_parse_shnifter_script_basic():
    """Test the parse_shnifter_script function."""
    raw_lines = ["echo 'Hello World'"]
    error, script = parse_shnifter_script(raw_lines)
    assert error == ""
    assert script == "/echo 'Hello World'"


def test_parse_shnifter_script_with_variable():
    """Test the parse_shnifter_script function."""
...
def test_parse_shnifter_script_with_foreach_loop():
    """Test the parse_shnifter_script function."""
...
def test_parse_shnifter_script_with_error():
    """Test the parse_shnifter_script function."""
...
def test_parse_shnifter_script_foreach_errors(line, expected):
    """Test the parse_shnifter_script function."""
    error, script = parse_shnifter_script([line])
...
def test_date_keyword_last_friday():
    ...
    assert match_and_return_shnifter_keyword_date("$LASTFRIDAY") == expected_date
