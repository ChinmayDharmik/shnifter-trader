"""
ShnifterUseClickOuideWidget - Shnifter Native Implementation
...
class ShnifterUseClickOuideWidget(QWidget):
    """
    Shnifter implementation of useOnClickOutside
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_tables_useonclickoutside_" + str(uuid.uuid4())[:8]
    ...
    def setup_ui(self):
        ...
        # Header
        header = QLabel("🔍 useOnClickOutside")
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterUseClickOuideWidget",
...
def create_useonclickoutside_widget(parent=None, **kwargs) -> ShnifterUseClickOuideWidget:
    """Create useOnClickOutside widget instance"""
    return ShnifterUseClickOuideWidget(parent=parent, **kwargs)
