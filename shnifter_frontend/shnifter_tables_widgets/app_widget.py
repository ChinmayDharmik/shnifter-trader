"""
ShnifterAppWidget - Shnifter Native Implementation
...
class ShnifterAppWidget(QWidget):
    """
    Shnifter implementation of transformData
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_tables_transformdata_" + str(uuid.uuid4())[:8]
...
def create_transformdata_widget(parent=None, **kwargs) -> ShnifterAppWidget:
    """Create transformData widget instance"""
    return ShnifterAppWidget(parent=parent, **kwargs)
