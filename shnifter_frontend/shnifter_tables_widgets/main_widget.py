"""
ShnifterMainWidget - Shnifter Native Implementation
...
class ShnifterMainWidget(QWidget):
    """
    Shnifter implementation of Component
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_tables_component_" + str(uuid.uuid4())[:8]
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterMainWidget",
...
def create_component_widget(parent=None, **kwargs) -> ShnifterMainWidget:
    """Create Component widget instance"""
    return ShnifterMainWidget(parent=parent, **kwargs)
