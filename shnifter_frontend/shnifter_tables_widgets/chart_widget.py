...
class ShnifterChartWidget(QWidget):
    """
    Shnifter implementation of Chart
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_tables_chart_" + str(uuid.uuid4())[:8]
...
def create_chart_widget(parent=None, **kwargs) -> ShnifterChartWidget:
