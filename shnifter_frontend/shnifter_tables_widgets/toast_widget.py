"""
ShnifterToastWidget - Shnifter Native Implementation
...
class ShnifterToastWidget(QLabel):
    """
    Shnifter implementation of Toast
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_tables_toast_" + str(uuid.uuid4())[:8]
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterToastWidget",
...
def create_toast_widget(parent=None, **kwargs) -> ShnifterToastWidget:
    """Create Toast widget instance"""
    return ShnifterToastWidget(parent=parent, **kwargs)
