"""
ShnifterSuccessWidget - Shnifter Native Implementation
...
class ShnifterSuccessWidget(QLabel):
    """
    Shnifter implementation of SuccessIcon
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_tables_successicon_" + str(uuid.uuid4())[:8]
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterSuccessWidget",
...
def create_successicon_widget(parent=None, **kwargs) -> ShnifterSuccessWidget:
    """Create SuccessIcon widget instance"""
    return ShnifterSuccessWidget(parent=parent, **kwargs)
