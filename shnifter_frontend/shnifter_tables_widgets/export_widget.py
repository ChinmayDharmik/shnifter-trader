"""
ShnifterExportWidget - Shnifter Native Implementation
...
class ShnifterExportWidget(QWidget):
    """
    Shnifter implementation of Export
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_tables_export_" + str(uuid.uuid4())[:8]
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterExportWidget",
...
def create_export_widget(parent=None, **kwargs) -> ShnifterExportWidget:
    """Create Export widget instance"""
    return ShnifterExportWidget(parent=parent, **kwargs)
