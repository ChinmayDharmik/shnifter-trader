"""
ShnifterIndexWidget - Shnifter Native Implementation
...
class ShnifterIndexWidget(QDialog):
    """
    Shnifter implementation of Table
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_tables_table_" + str(uuid.uuid4())[:8]
    ...
    def setup_ui(self):
        ...
        self.setWindowTitle
        self.setWindowTitle("Shnifter Table")
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterIndexWidget",
...
def create_table_widget(parent=None, **kwargs) -> ShnifterIndexWidget:
    """Create Table widget instance"""
    return ShnifterIndexWidget(parent=parent, **kwargs)
