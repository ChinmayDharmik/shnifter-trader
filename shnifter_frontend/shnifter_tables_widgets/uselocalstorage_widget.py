"""
ShnifterUseLocalStorageWidget - Shnifter Native Implementation
...
class ShnifterUseLocalStorageWidget(QWidget):
    """
    Shnifter implementation of useLocalStorage
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_tables_uselocalstorage_" + str(uuid.uuid4())[:8]
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterUseLocalStorageWidget",
...
def create_uselocalstorage_widget(parent=None, **kwargs) -> ShnifterUseLocalStorageWidget:
    """Create useLocalStorage widget instance"""
    return ShnifterUseLocalStorageWidget(parent=parent, **kwargs)
