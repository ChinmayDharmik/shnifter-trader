"""
ShnifterUseDarkModeWidget - Shnifter Native Implementation
...
class ShnifterUseDarkModeWidget(QWidget):
    """
    Shnifter implementation of useDarkMode
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_tables_usedarkmode_" + str(uuid.uuid4())[:8]
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterUseDarkModeWidget",
...
def create_usedarkmode_widget(parent=None, **kwargs) -> ShnifterUseDarkModeWidget:
    """Create useDarkMode widget instance"""
    return ShnifterUseDarkModeWidget(parent=parent, **kwargs)
