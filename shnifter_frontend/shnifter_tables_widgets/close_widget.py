"""
ShnifterCloseWidget - Shnifter Native Implementation
...
class ShnifterCloseWidget(QLabel):
    """
    Shnifter implementation of CloseIcon
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_tables_closeicon_" + str(uuid.uuid4())[:8]
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterCloseWidget",
...
def create_closeicon_widget(parent=None, **kwargs) -> ShnifterCloseWidget:
    """Create CloseIcon widget instance"""
    return ShnifterCloseWidget(parent=parent, **kwargs)
