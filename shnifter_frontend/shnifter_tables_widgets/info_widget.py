"""
ShnifterInfoWidget - Shnifter Native Implementation
...
class ShnifterInfoWidget(QLabel):
    """
    Shnifter implementation of InfoIcon
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_tables_infoicon_" + str(uuid.uuid4())[:8]
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterInfoWidget",
...
def create_infoicon_widget(parent=None, **kwargs) -> ShnifterInfoWidget:
    """Create InfoIcon widget instance"""
    return ShnifterInfoWidget(parent=parent, **kwargs)
