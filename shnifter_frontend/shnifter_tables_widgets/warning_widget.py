"""
ShnifterWarningWidget - Shnifter Native Implementation
...
class ShnifterWarningWidget(QLabel):
    """
    Shnifter implementation of WarningIcon
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_tables_warningicon_" + str(uuid.uuid4())[:8]
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterWarningWidget",
...
def create_warningicon_widget(parent=None, **kwargs) -> ShnifterWarningWidget:
    """Create WarningIcon widget instance"""
    return ShnifterWarningWidget(parent=parent, **kwargs)
