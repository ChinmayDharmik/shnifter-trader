"""
ShnifterSelectWidget - Shnifter Native Implementation
...
class ShnifterSelectWidget(QLabel):
    """
    Shnifter implementation of Select
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_tables_select_" + str(uuid.uuid4())[:8]
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterSelectWidget",
...
def create_select_widget(parent=None, **kwargs) -> ShnifterSelectWidget:
    """Create Select widget instance"""
    return ShnifterSelectWidget(parent=parent, **kwargs)
