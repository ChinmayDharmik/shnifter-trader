"""
ShnifterResizeHandlerWidget - Shnifter Native Implementation
...
class ShnifterResizeHandlerWidget(QWidget):
    """
    Shnifter implementation of ResizeHandler
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_plotly_resizehandler_" + str(uuid.uuid4())[:8]
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterResizeHandlerWidget",
...
def create_resizehandler_widget(parent=None, **kwargs) -> ShnifterResizeHandlerWidget:
    """Create ResizeHandler widget instance"""
    return ShnifterResizeHandlerWidget(parent=parent, **kwargs)
