"""
ShnifterTextChartDialogWidget - Shnifter Native Implementation
...
class ShnifterTextChartDialogWidget(QDialog):
    """
    Shnifter implementation of TextChartDialog
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_plotly_textchartdialog_" + str(uuid.uuid4())[:8]
    ...
    def setup_ui(self):
        ...
        self.setWindowTitle
        self.setWindowTitle("Shnifter TextChartDialog")
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterTextChartDialogWidget",
...
def create_textchartdialog_widget(parent=None, **kwargs) -> ShnifterTextChartDialogWidget:
    """Create TextChartDialog widget instance"""
    return ShnifterTextChartDialogWidget(parent=parent, **kwargs)
