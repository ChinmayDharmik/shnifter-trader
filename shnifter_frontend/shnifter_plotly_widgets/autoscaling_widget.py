"""
ShnifterAutoScalingWidget - Shnifter Native Implementation
...
class ShnifterAutoScalingWidget(QWidget):
    """
    Shnifter implementation of merge
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_plotly_merge_" + str(uuid.uuid4())[:8]
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterAutoScalingWidget",
...
def create_merge_widget(parent=None, **kwargs) -> ShnifterAutoScalingWidget:
    """Create merge widget instance"""
    return ShnifterAutoScalingWidget(parent=parent, **kwargs)
