"""
ShnifterAddAnnotationWidget - Shnifter Native Implementation
...
class ShnifterAddAnnotationWidget(QDialog):
    """
    Shnifter implementation of add_annotation
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_plotly_add_annotation_" + str(uuid.uuid4())[:8]
    ...
    def setup_ui(self):
        ...
        self.setWindowTitle
        self.setWindowTitle("Shnifter add_annotation")
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterAddAnnotationWidget",
...
def create_add_annotation_widget(parent=None, **kwargs) -> ShnifterAddAnnotationWidget:
    """Create add_annotation widget instance"""
    return ShnifterAddAnnotationWidget(parent=parent, **kwargs)
