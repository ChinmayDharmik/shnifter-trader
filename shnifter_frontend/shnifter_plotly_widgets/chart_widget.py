"""
ShnifterChartWidget - Shnifter Native Implementation
...
class ShnifterChartWidget(QDialog):
    """
    Shnifter implementation of getXRange
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_plotly_getxrange_" + str(uuid.uuid4())[:8]
    ...
    def setup_ui(self):
        ...
        self.setWindowTitle
        self.setWindowTitle("Shnifter getXRange")
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterChartWidget",
...
def create_getxrange_widget(parent=None, **kwargs) -> ShnifterChartWidget:
    """Create getXRange widget instance"""
    return ShnifterChartWidget(parent=parent, **kwargs)
