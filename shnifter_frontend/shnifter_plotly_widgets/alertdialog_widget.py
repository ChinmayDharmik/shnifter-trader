"""
ShnifterAlertDialogWidget - Shnifter Native Implementation
...
class ShnifterAlertDialogWidget(QDialog):
    """
    Shnifter implementation of AlertDialog
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_plotly_alertdialog_" + str(uuid.uuid4())[:8]
    ...
    def setup_ui(self):
        ...
        self.setWindowTitle
        self.setWindowTitle("Shnifter AlertDialog")
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterAlertDialogWidget",
...
def create_alertdialog_widget(parent=None, **kwargs) -> ShnifterAlertDialogWidget:
    """Create AlertDialog widget instance"""
    return ShnifterAlertDialogWidget(parent=parent, **kwargs)
