"""
ShnifterPlotlyConfigWidget - Shnifter Native Implementation
...
class ShnifterPlotlyConfigWidget(QDialog):
    """
    Shnifter implementation of hideModebar
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # Widget properties
        self.widget_id = "shnifter_plotly_hidemodebar_" + str(uuid.uuid4())[:8]
    ...
    def setup_ui(self):
        ...
        self.setWindowTitle
        self.setWindowTitle("Shnifter hideModebar")
    ...
    def get_widget_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "widget_type": "ShnifterPlotlyConfigWidget",
...
def create_hidemodebar_widget(parent=None, **kwargs) -> ShnifterPlotlyConfigWidget:
    """Create hideModebar widget instance"""
    return ShnifterPlotlyConfigWidget(parent=parent, **kwargs)
